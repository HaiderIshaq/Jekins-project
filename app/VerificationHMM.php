...
class VerificationHMM extends Model
{
  
    public static function applicantWorkplaceReportforhomeemp($request,$pdf,$survey,$id)
    {
        $pdf->setSourceFile("src/reportformat/hmm/workplaceperfomaemployee.pdf");
    ...
    {
        $pdf->setSourceFile("src/reportformat/hmm/workplaceperfomabusiness.pdf");
    ...
    {
        $pdf->setSourceFile("src/reportformat/hmm/salaryperfoma.pdf");
    ...
    public static function applicantResidenceReport($request,$pdf,$survey,$id)
    {
        ...
        $pdf->setSourceFile("src/reportformat/hmm/residenceperfoma.pdf");
       ...
       $recs=count($job);
          ...
          if($recs>0)
          {
           ...
           $pdf->useTemplate($tplIdx, 0, 0);
            ...
            // $pdf->SetTextColor(255, 0, 0);
            $pdf->SetXY(11, 35);
            $pdf->Write(0, 'Habib Metro Modaraba');
    ...
    public static function getresidenceReport($request,$pdf,$survey,$appinfo)
    {
        ...
        if($apptype=="Home")
        {
            ...
            // elseif($appsubtype=="Co-Applicant")
            // {
            //     $Verification = new VerificationHMM();
