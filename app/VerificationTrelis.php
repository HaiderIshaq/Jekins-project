...
class VerificationTrelis extends Model
{
  
    public static function applicantWorkplaceReportforhomeemp($request,$pdf,$survey,$id)
    {
        $pdf->setSourceFile("src/reportformat/nbr/workplaceperfomaemployee.pdf");
    ...
    {
        $pdf->setSourceFile("src/reportformat/nbr/workplaceperfomabusiness.pdf");
    ...
    {
        $pdf->setSourceFile("src/reportformat/nbr/salaryperfoma.pdf");
    ...
    public static function applicantResidenceReport($request,$pdf,$survey,$id)
    {
        ...
        $pdf->setSourceFile("src/reportformat/nbr/residenceperfoma.pdf");
       ...
       $recs=count($job);
          ...
          if($recs>0)
          {
           ...
           $pdf->useTemplate($tplIdx, 0, 0);
            ...
            // $pdf->SetTextColor(255, 0, 0);
            $pdf->SetXY(11, 35);
            $pdf->Write(0, 'NATIONAL BANK OF PAKISTAN');
    ...
    public static function getresidenceReport($request,$pdf,$survey,$appinfo)
    {
        ...
        if($apptype=="Home")
        {
            ...
            // elseif($appsubtype=="Co-Applicant")
            // {
            //     $Verification = new VerificationTrelis();
