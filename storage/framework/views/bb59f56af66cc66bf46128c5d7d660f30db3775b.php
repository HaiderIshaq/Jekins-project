    ...
    <div class="container-fluid" style="padding-top: 60px">
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:0px; line-height:0.5px;">
            ...
            <div class="row" style="padding:5px 5px;width:100%">
                ...
                <div class="box-tab" style="width:45%;float: left;padding:5px">
                    <span><?php echo e($bill_date); ?></span>
                </div>
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:50px; line-height:0.5px;">
                ...
                <div class="row" style="padding:5px 5px;width:100%">
                    ...
                    <div class="box-tab" style="width:40%;float: left;padding:5px">
                        <span><b><?php echo e($is_takaful==0?'INSURANCE COMPANY':'TAKAFUL COMPANY'); ?></b></span>
                    </div>

                    <div class="box-tab" style="width:45%;float: left;padding:5px">
                        <span><?php echo e($insurer_name); ?> <br><br><br> <br><br><br> <br><br><br> <br><br><br> <br><br><br> <?php echo e($insurer_branch_name); ?></span> <br>
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:50px; line-height:0.5px;">
                ...
                <div class="row" style="padding:5px 5px;width:100%">
                    ...
                    <div class="box-tab" style="width:45%;float: left;padding:5px">
                        <span><?php echo e($service_charges); ?></span>
                    </div>
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:50px; line-height:0.5px;">
                ...
                <div class="row" style="padding:5px 5px;width:100%">
                    ...
                    <div class="box-tab" style="width:40%;float: left;padding:5px">
                        <span><b>ADD <?php echo e($rate); ?>% SST</b></span>
                    </div>
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:50px; line-height:0.5px;">
                ...
                <div class="row" style="padding:5px 5px;width:100%">
                    ...
                    <div class="box-tab" style="width:45%;float: left;padding:5px">
                        <span><?php echo e($total_amount); ?></span>
                    </div>
        ...
        <div class="container"  style="margin:0 auto;width:90%;margin-top:0px; line-height:0.5px;">
                ...
                <div class="row" style="padding:5px 5px;width:100%">
                    ...
                    <div class="box-tab" style="width:50%;float: left;padding:5px">
                        <span><?php echo e($total_amount_text); ?></span>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Prism/Report/Partial/salestaxinvoice.blade.php ENDPATH**/ ?>