    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <table style="margin-top:20px">
                ...
                <tbody>
                <?php $__currentLoopData = $data[7]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                ...
                <tr > 
                    ...
                    <td colspan="4" style="font-size:12px"> <span style="font-weight:bold"> Rupees </span>: <?php echo e(ucwords($data[2])); ?></td>
                    ...
                    <td style="font-size:12px">  
                        <?php echo e(number_format($data[3])); ?><br style="height:10px">                                         
                    </td>
                    </tr>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Verification/verinvoicetrelis.blade.php ENDPATH**/ ?>