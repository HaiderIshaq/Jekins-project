...
<div class="row ">
   ...
   <div class="row">
    <p><b>The Manager<br>
        <?php echo e(strtoupper($data[1])); ?><?php echo e(strtoupper($data[13])); ?><br>
        <?php echo e(ucwords($data[2])); ?><?php echo e(ucwords($data[15])); ?><br></b></p>
       ...
       <div class="row pb-0">
                ...
                <div class="head1">
                    <span><b>Bill No: </b><?php echo e($data[3]); ?></span>
                </div>
                <div class="head2">
                <span > <b>Dated</b>: <?php echo e(date('d-M-Y')); ?><span>
                </div>
        ...
        <table style="border:1px">
            <tr>
                <td>
                    ...
                    <br>
                    <p><b><?php echo e(strtoupper($data[2])); ?><?php echo e(strtoupper($data[15])); ?></b></p>
                    <br>
                    <p>Reference :  <?php echo e($data[5]); ?> <?php echo e($data[19]); ?> <br>
                    Dated: <?php echo e($data[6]); ?></p>
                    <br>
                    <p>Service Chargers : US $<?php echo e($data[7]); ?> <br>
                    Exchange Rate : <?php echo e($data[8]); ?> <br>
                    Sales Tax : <?php echo e($data[0]); ?>%
                    </p>
                    <!-- <p>Rupees: One Thousand Eight Hundred Only</p> -->
                </td>
                <td><?php echo e(number_format($data[9])); ?>
                ...
                <br>
                <br>
                    <?php echo e($data[11]); ?></td>
            </tr>
            <tr>
                <td>Total</td>
                <td><b><?php echo e(number_format($data[10] )); ?></b></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/invoice.blade.php ENDPATH**/ ?>