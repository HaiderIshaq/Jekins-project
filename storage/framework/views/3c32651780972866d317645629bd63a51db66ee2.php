    ...
    <div >
        <div class="container-fluid" style="padding-top:100px">
            ...
            <div class="row">
                ...
                <h4 style="text-decoration:underline;text-align:center;line-height:0.1;"><b><?php echo e($data['is_takaful']==0?'INSURANCE SURVEY REPORT':'TAKAFUL SURVEY REPORT'); ?></b></h4>
                            ...
                            <tr >
                                ...
                                <td style="padding-left: 100px;">
                                        ...
                                        <table style="border:0px;">
                                            ...
                                            <tr style="width:100%">
                                                <td  style="border:0px;padding:4px;width:175px"><?php echo e($data['is_takaful']==0?'Name of Insured:':'Name of Participant:'); ?></td>
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="border:0px;padding:4px;width:85%"><b><?php echo e($data['address']); ?></b></td>
                                            </tr>
                                            <tr style="">
                                            ...
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px"><?php echo e($data['is_takaful']==0?'Policy #:':'PMD #:'); ?></td>
                                                <td style="border:0px;padding:4px;"><b><?php echo e($data['policy_no']); ?></b></td>
                                            </tr>
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px"><?php echo e($data['is_takaful']==0?'Validity':'Period'); ?> From: </td>
                                                <td style="border:0px;padding:4px;width:140px"><b> <?php echo e($data['validity_from']); ?></b></td>
                                                <td style="border:0px;padding:4px;width:140px">To:</td>
                                                <td style="border:0px;padding:4px;width:140px"><b><?php echo e($data['validity_to']); ?></b></td> 
                                            </tr>
                                            <?php endif; ?>
                                            ...
                                            <tr style="">
                                                ...
                                                <td style="border:0px;padding:4px;width:240px">
                                                    <b style="text-decoration: underline">Particulars of <?php echo e($data['is_takaful']==0?'Insured Item:':'Participant Item'); ?></b>
                                                </td>
                                            </tr>
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px">Registration #:</td>
                                                <td style="border:0px;padding:4px;">
                                                   <?php echo e($data['reg_no']); ?>
                                            ...
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px"><?php echo e($data['survey_item']); ?>:</td>
                                                <td style="border:0px;padding:4px;width:140px"> <?php echo e($data['make']); ?></td>
                                                <td style="border:0px;padding:4px;width:140px">Model:</td>
                                                <td style="border:0px;padding:4px;width:140px"><?php echo e($data['model']); ?></td> 
                                            </tr>
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px">Engine #:</td>
                                                <td style="border:0px;padding:4px;width:140px"> <?php echo e($data['engine_no']); ?></td>
                                                <td style="border:0px;padding:4px;width:140px">H.P/C.C:</td>
                                                <td style="border:0px;padding:4px;width:140px"><?php echo e($data['engine_capacity']); ?></td> 
                                            </tr>
                                            <tr style="">
                                                <td  style="border:0px;padding:4px;width:140px">Chassis #:</td>
                                                <td style="border:0px;padding:4px;"><?php echo e($data['chassis_no']); ?></td>
                                            </tr>
