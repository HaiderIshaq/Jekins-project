...
<body>  
        ...
        <div class="container-fluid" style="padding-top: 55px">
            <div>
                <h3 style="text-decoration: underline;text-align:center">Vehicle - Lumpsum  Survey Report</h3>
            </div>
        ...
        <div class="container"  style="margin:0 auto;width:90%;border:2px solid black;margin-top:6px">
                <div style="width:100%;padding:0px;">
                    <p style="font-size:12px;margin:8px">This is to certify that at the request of the Insurance Company we, the Insurance Surveyors, conducted
                ...
                <div class="row" style="padding:5px 5px">
                    <div class="heading-box">
                        <h5 style="margin:0">Detail of <?php echo e($is_takaful==0?'Insured':'Takaful Company'); ?></h5>
                     </div>
                    <div class="box box1" style="width:50%">
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Prism/Report/Partial/lumpsumReport1.blade.php ENDPATH**/ ?>