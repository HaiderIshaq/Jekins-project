...
<body>
    ...
    <?php endif; ?>
        <div class="container" style="margin:0 auto; width:90%; padding-top:85px;">
            <div class="row" >
                <div class="box box1">
                    Ref:-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($job_id); ?>

                </div>
                <div class="box box2">
                    Date: <?php echo e($report_date); ?>
        ...
        <div class="container" style="margin:0 auto;width:90%">
            <div class="row" style="padding-top:10px;padding-bottom:10px" >
                ...
                <b>The Manager,</b><br>
                    ...
                    <?php echo e($insurer_name); ?>.<br>
                    <?php echo e($insurer_branch_name); ?><br>
                    <?php echo e($region_name); ?>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Prism/Report/Partial/NoLoss.blade.php ENDPATH**/ ?>