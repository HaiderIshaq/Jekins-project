...
<body>
    <div class="container-fluid" style="padding-top:100px">
        ...
        <div class="row " style="padding-bottom:5px">
            ...
            <div class="box box1">
                <span>Bill No:        <?php echo e($data[0]); ?></span>
            </div>
            <div class="box box2">
            <span >Dated:      <?php echo e($data[1]); ?><span>
            </div>
    ...
    <div class="row" style="font-size:13px;padding-bottom:30px">
          <?php if($data[2]=="Bank"): ?>
          <p><b>The Manager<br>
            <?php echo e(strtoupper($data[3])); ?><br>
            <?php echo e(ucwords($data[4])); ?>,
            <br></b>
            <b><?php echo e(ucwords($data[13])); ?></b>
            </p>
            <?php elseif($data[2]=="Customers"): ?>

            <p><b> <?php echo e(strtoupper($data[5])); ?><br>
            <?php echo e(ucwords($data[6])); ?>

            <br></b></p>
            <?php else: ?>

            <p><b> <?php echo e(strtoupper($data[11])); ?><br>
            <?php echo e(ucwords($data[12])); ?>
   ...
   <table style="border:1px;font-size:">
            <tr >
                <td style="padding:30px 30px 30px 30px">
                    ...
                    <p>Particulars :  INSPECTION OF L/S STOCKS </p><br>
                        <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;REF:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($data[7]); ?> </span><br><br>
                    <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e($data[8]); ?> </span><br><br>



                    <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M/S.    <?php echo e(strtoupper($data[5])); ?> </span><br><br>
                    ...
                    <p>Rupees: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(ucwords($data[9])); ?> Only</p>
                </td>
                ...
                <!-- Survey Charges -->
                <p style="padding-top:10px;padding-bottom:10px"><?php echo e(number_format($data[14])); ?></p><br>
                <!-- Survey Charges -->
               
                <!-- Traveling Charges -->
                <?php if($data[15] > 0): ?>
                <p style="padding-top:10px;padding-bottom:10px"><?php echo e(number_format($data[15])); ?></p><br>

                <?php endif; ?>
                <!-- Traveling Charges -->
               
                <!-- Total -->
                <p style="padding-top:10px;padding-bottom:10px"><?php echo e(number_format($data[16])); ?></p><br> 
                <!-- Total -->
               
                <?php if($data[17] > 0): ?>

                <!-- SST -->
                <p style="padding-top:10px;padding-bottom:10px"><?php echo e(number_format($data[17])); ?>%</p><br>
                <p style="padding-top:10px;padding-bottom:10px"><?php echo e(number_format($data[18])); ?></p><br>
                <!-- SST -->
                <?php endif; ?>
            ...
            <tr >
                ...
                <td style="text-align:right"><b> <?php echo e(number_format($data[10])); ?></b></td>
            </tr>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Inspection/insinvoice.blade.php ENDPATH**/ ?>