...
<body>
        ...
        <div class="container"  style="padding:3px 5px;margin:0 auto;width:90%;border:2px solid black;margin-top:8px;height:75%">
                <div style="width:100%;padding:0px;">
                    <span style="font-size:13px;margin:8px">M/s. <?php echo e($insurer_name); ?>

                    </span><br>
                    <span style="font-size:13px;margin:8px"><?php echo e($insurer_branch_name); ?>
                ...
                <div class="row" style="padding:5px 0px;width:100%">
                    ...
                    <div class="box-tab" style="width:45%;float: left;border:1px solid black;padding:5px">
                        <table>
                            <tr>
                                <th><?php echo e($is_takaful==0?'Insured':'Participant'); ?></th>
                                
                                <td><?php echo e($name_of_insured); ?></td>
                            </tr>
                            <tr>
                                <th><?php echo e($is_takaful==0?'Policy #':'PMD #'); ?></th>
                                
                                <td><?php echo e($policy_no); ?></td>
                            </tr>
                            <tr>
                                <th>Endorsement #</th>
                                
                                <td><?php echo e($endors_no); ?></td>
                            </tr>
                            <tr>                         
                                <th>Loss #</th>
                                
                                <td><?php echo e($loss_no); ?></td>
                            </tr>

                            <tr>                           
                                <th>Sum Insured</th>
                                
                                <td><?php echo e($sum_insured); ?></td>
                            </tr>
                    ...
                    <div class="box-tab" style="width:45%;float: left;border:1px solid black;padding:5px">
                        <table>
                            ...
                            <tr>                         
                                ...
                                <td><?php echo e($engine_no); ?></td>
                            </tr>

                            <tr>                           
                                <th>Chassis #</th>
                                
                                <td><?php echo e($chassis_no); ?></td>
                            </tr>
                    ...
                    <div class="heading-boxs" style="width:94%;padding:0px;">
                        <p style="font-size:12px;margin:4px"><?php echo e($circumstances); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="row" style="padding:3px 5px;width:100%">
                    ...
                    <div  style="width:48%;float: left;padding:3px">
                        <div class="row">
                            ...
                            <div class="box box2" style="font-size:12px;text-align:right"><b>  <?php echo e($repaired_labour); ?></b></div>
                        </div>
                    </div>
                    <div  style="width:48%;float: left;padding:3px">
                        <div class="row">
                            <div class="box box1" style="font-size:12px"><b> Labour Assessed &nbsp;&nbsp; </b></div>
                            <div class="box box2" style="font-size:12px;text-align:right"><b>   <?php echo e($repaired_assesed); ?></b></div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\kgt-erp\resources\views/Prism/Report/Partial/preliminaryReport.blade.php ENDPATH**/ ?>