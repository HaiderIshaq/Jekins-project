                                    ...
                                    <td style="padding-left: 70px;">
                                            ...
                                            <table style="border:0px;">
                                                ...
                                                <tr style="">
                                                    ...
                                                    <td style="border:0px;padding:4px;width:100px"><b> {{$data['validity_from']}}</b></td>
                                                    <td style="border:0px;padding:4px;width:100px">To:</td>
                                                    <td style="border:0px;padding:4px;width:100px"><b>{{$data['validity_to']}}</b></td> 
                                                </tr>
