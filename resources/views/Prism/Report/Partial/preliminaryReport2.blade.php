        ...
        <div class="container"  style="margin:0 auto;width:90%;border:2px solid black;">
            ...
            <div class="row" style="padding:3px 5px;width:100%">
                ...
                @foreach ($replaced as $rec)
                    ...
                    <div class="box" style="width:48%;float: left;border:1px solid black;padding:3px">
                        <div class="row">
                            <div class="box box1">{{ucwords($rec->title)}}</div>
                            @if($part_rates==true)
                            <div class="box box2" style="text-align: right">{{number_format($rec->amount)}}</div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="row" style="padding:3px 5px;width:100%">
                ...
                <div class="box" style="width:48%;float: left;border:1px solid black;padding:3px">
                    ...
                    {{-- @endif --}}
                        ...
                        <div class="row">
                            <div class="box box1">{{ucwords($value->title)}}</div>
                            <div class="box box2" style="text-align: right">{{number_format($value->amount)}}</div>
                        </div>
                    </div>
            ...
            {{-- @endif --}}
                ...
                @if(count($dismantle)+count($replaced)<23)
