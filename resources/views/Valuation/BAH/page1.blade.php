...
<div class="container" style="margin:0px 0px 20px 8px">
    ...
    <div class="row"  >
        <img style="margin-top:40px !important;margin-left:50px"  src="{{$frontImage}}"  height="400" width="600" alt="">
   </div>
   <br>
   <br>
   <div class="row" style="margin-left:45px">
        <p  style="font-size:20px;text-decoration:underline;text-align:center;line-height:0.1"><b>CLIENT: {{ $client_name }}</b></p>
        <p style="font-size:20px;text-decoration:underline;text-align:center;line-height:1.2"><b>APPLICANT: {{ $applicant }}</b></p>
   </div>
