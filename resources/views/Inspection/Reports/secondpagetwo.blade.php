...
<body>
    <div class="container" style="padding-left:80px;padding-right:80px">
        ...
        <div class="row">
            <h4 style="text-decoration:underline;text-align:center;line-height:0.1;padding-right:30px"><b>LIVESTOCK/ANIMAL INSPECTION REPORT</b></h4>
            <h4 style="text-align:center;line-height:0.1;padding-right:30px"><b>(Region-{{$data[6]}})</b></h4>
          ...
          @endif
            ...
            <div class="row" style="margin-top:10px">
                <h4 style="line-height:0.1;"><b>Details of Animals</b></h4>
            </div>
         <div class="row "  >
