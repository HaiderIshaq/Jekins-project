        ...
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">New MVR Job</h4>
                    </div>
                    <div class="col-md-2" style="text-align: right;">
                        <a href="/bir" style="margin-top: 12px;margin-left: 50px;
                      color: black;
...
<br>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Nature:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Operating?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">Yes</label>
                                    </div>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">No</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Name Affixed?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                 ...
                                 <!-- <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Operating since:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Name of Owner:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">NIC of Owner:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Telephone:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Size:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Business Level:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Sales Volume:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Contact Person:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Desgination:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Number of Employee:</label>
                                    <div class="col-md-9">
                                       <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Business Type?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Criteria Match?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Activity?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Verification?:</label>
                                    <div class="col-md-3">
                                       <input type="radio" name="" id=""> <label for="" class="col-form-control">N/A</label>
                                    </div>
                                    <div class="col-md-3">
                                 ...
                                 <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Visit Date:</label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Comments:</label>
                                    <div class="col-md-9">
                                        <textarea class="form-control" style="height: 50px;" name="" id="" cols="42"
                                            rows="1"></textarea>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                           <input type="checkbox" name="" id=""> <label for="" class="col-form-label">Sales Tax?</label>
                                    </div>
                                </div>
