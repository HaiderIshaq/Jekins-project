    ...
    <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
        ...
        <div class="clearfix"  >
            <div class="row" style="background-color:#275129;padding-bottom:15px">
                <div class="col-md-10">
                    <h4 class="text-white  pt-3">Edit Legal Service Job</h4>
                </div>
                <div class="col-md-2" style="text-align: right;">
                      <a href="/Dashboard" style="margin-top: 12px;margin-left: 50px;
                      color: black;
        ...
        <div class="row" style="padding: 5px 5px 9px">

            <div class="col-md-12" style="text-align:left;padding-left:10px">
                        <div class="row" style="float:left">
                        <div class="mr-3" style="margin-left: 15px;">
                            <a href="/printLegalBill" target="_blank">   </a>
                            <input @click="printLegalBill()" type="button" v-if="printButton"  class="btn btn-primary" value="Print Bill">
                                                    ...
                                                    <form enctype="multipart/form-data">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="number" v-model="lmNumber" class="form-control" />
                                                                <!-- <div v-if="$v.customerCode1.$error">
                                                                    <p class="text-danger"
...
import '@trevoreyre/autocomplete-vue/dist/style.css'
  export default {
    ...
    mounted(){
        ...
        this.path=document.location.origin+'/Reports/Legal/'+this.id+'/';

       this.getLegalServiceJob();
    ...
    methods: {
     ...
     getLegalServiceJob(){
        axios.get('/getLegalServiceJob/' + this.id)
        .then(res=>{
            ...
            res.data.job.forEach((obj)=>{
                ...
                this.regionIs=obj.region_is;
                this.task ={text:obj.task};
                this.lineManager ={text:obj.line_manager};
                this.saleReg = {text:obj.salesRegion};
                this.deliveryTime = obj.delivery_time;
                this.isRemarks = obj.remarks;
                this.serviceCharges = obj.service_charges;
                this.isSalesTax = Number(obj.sales_tax)===1 ? true:false;
   ...
   onComplete: function(){
        ...
        //  var cmpname=string.replace(/[{()}^0-9-]/g, "");
           ...
           axios.put('/updateLegalService/' + this.id ,{
  ...
  cancelJob: function(){
            ...
            axios.put('/cancelLegalService/' + this.id ,{
  ...
  holdJob: function(){
            ...
            axios.put('/holdLegalService/' + this.id ,{
  ...
  addDocuments(){
    ...
    formData.append('job_id', this.id);
        ...
        axios.post('/uploadLegalServiceDocuments',formData).then(res=>{
            alert('File Uploaded');
    ...
    //    this.finalDraft="";
            // this.finalDraft=document.location.origin+'/Reports/Valuation/'+this.id+'/final.pdf';
             axios.get('/getLegalServiceFiles/' +this.id)
                    .then(res=>{
    ...
    printLegalBill(){
        ...
        this.loading=true;
        axios.post('/printLegalBill',billData,{responseType: 'arraybuffer'}).then(res=>{
