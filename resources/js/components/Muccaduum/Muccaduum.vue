        ...
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">New Muccadum Job</h4>
                    </div>
                    <div class="col-md-2" style="text-align: right;">
                        <a href="//Muccaduum" style="margin-top: 12px;margin-left: 50px;
                      color: black;
                        ...
                        <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                            ...
                            <div class="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" class="form-control cus_input" id="" name="" value="">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <Select :options="regions" label="text" v-model="operationalBranch"></Select>
                                        <!-- <select class="form-control" name="location" id="location">
                                            <option value="abc">abc</option>
                                        </select> -->
                                        <div v-if="$v.operationalBranch.$error">
                                            <p class="text-danger" v-if="!$v.operationalBranch.email">Required</p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 pl-3">
                                        <input class="form-control form-control-sm"  name="" v-model="serviceCharge" type="number">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2 custom-control custom-radio " style="padding: 5px 15px;">
                                        <input type="radio" name="" class="custom-radio" id=""> <label for="">SME</label>
                                    </div>
                                    <div class="col-md-4 custom-control custom-radio " style="padding: 5px 15px;">

                                        <input type="radio" name="" class="custom-radio" id=""> <label for="">Commercial</label>
                                    </div>
                                    <div class="col-md-3 custom-control custom-radio " style="padding: 5px 15px;">

                                        <input type="radio" name="" class="custom-radio" id=""> <label for="">Corporate</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">FootNote/Godown Keepers:</label>
                                    <div class="col-md-9">
                                        <textarea class="form-control" style="height: 50px;" name="" id="" cols="42"
                                        rows="1"></textarea>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="checkbox" name="" id=""> <label for="">Print Weight with Quantity</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Weight Separately</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print D/O Nos in Stcok Report</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Total in Stock Report</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Item then L/C</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Ship Breaking</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print LoT Details</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Annexured Report</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Bank Logo</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Value for NIB</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Total on First Page</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Godown Keeper(s) on Stock Report</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print Aging</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Islamic Asset Management</label><br>
                                        <input type="checkbox" name="" id=""> <label for="">Print with Landed Cost</label>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            ...
            postdata() {
                ...
                axios.post('/api/addMucJob', jobData, {
                        headers: headers
                    })
                    .then(res => {
