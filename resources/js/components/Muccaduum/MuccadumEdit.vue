        ...
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">Edit Muccadum Job</h4>
                    </div>
                    <div class="col-md-2" style="text-align: right;">
                        <a href="/w" style="margin-top: 12px;margin-left: 50px;
                      color: black;
            ...
            <div class="row" style="padding: 5px 5px 9px 5px;">
                ...
                <div class="col-md-12" style="text-align:left;">
                    <div class="row" style="float:left">
                        <input type="button" v-on:click="letterModal=false" class="btn btn-primary " data-toggle="modal"
                            data-target="#letterModal" style="margin-left: 10px;margin-right: 10px;" value="Letter(s)">
                        <input type="button" v-on:click="letterReportModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#letterReportModal"
                            style="margin-left: 10px;margin-right: 10px;" value="Letter Report">
                        <input type="button" v-on:click="stockRecevingModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#stockRecevingModal"
                            style="margin-left: 10px;margin-right: 10px;" value="Stock Receving (invoice)">
                        <input type="button" v-on:click="stockInsuranceModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#stockInsuranceModal"
                            style="margin-left: 10px;margin-right: 10px;" value="Stock Insurance (D/O)">
                        <input type="button" v-on:click="rateRevisionModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#rateRevisionModal"
                            style="margin-left: 10px;margin-right: 10px;" value="Rate Revision">
                        <input type="button" v-on:click="stockReportModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#stockReportModal"
                            style="margin-left: 10px;margin-right: 10px;" value="Stock ">
                        <input type="button" v-on:click="stockRegisterModalIs=false" class="btn btn-primary "
                            data-toggle="modal" data-target="#stockRegisterModal"
                            style="margin-left: 10px;margin-right: 20px;" value="Stock Register">
                    </div>
                            ...
                            <div class="col-md-12 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="" id="" cols="42" rows="1" class="form-control"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="" id="" placeholder="2) :">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label"></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label"></label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="" id="" placeholder="4) :">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label"></label>
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Designation:</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="" id="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row" style="padding-right:30px">
                                        <div class="col-md-12">
                                            ...
                                            <a href="/valuation"><input type="button" class="btn btn-primary"
            ...
            <div class="modal fade " id="letterReportModal" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="letterReport">Letter Report</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal fade " id="stockRecevingModal" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Stock Receving Invoice</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="col-md-12 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Reference No.:</label>
                                        <div class="col-md-9">
                                            <input type="text" name="" class="form-control" id="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Invoice No.:</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="" id="">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Bank Letter No.:</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" name="" id="">
                                        </div>
                                        <label for="" class="col-md-1 col-form-label">Date.:</label>
                                    ...
                                    <hr>
                                    <a href="#"><button class="btn btn-success"><i
                                                class="fa fa-plus pr-2"></i>Items</button></a>
                                    <a href="#"><button class="btn btn-success"><i
                                                class="fa fa-plus pr-2"></i>Lots</button></a>
            ...
            <div class="modal fade " id="stockInsuranceModal" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Stock Insurance (D/O)</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="modal fade " id="rateRevisionModal" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Rate Revision</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <a href="#"><button class="btn btn-success"><i class="fa fa-plus pr-2"></i>New
                                    Revision</button></a>
            ...
            <div class="modal fade " id="stockReportModal" tabindex="-1" role="dialog"
                aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Stock Report</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="col-md-12 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Last Date:</label>
                                        <div class="col-md-3">
                                            <input type="date" class="form-control" name="" id="">
                                        </div>
                                        <div class="col-md-1">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Financing Type:</label>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">All</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">Cash</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">FIM</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">DA</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">FCIF</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">Transit</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">Cotton</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">Oil</label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Select:</label>
                                        <div class="col-md-3">
                                            <input type="radio" name="" id=""> <label for="">Normal</label>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="radio" name="" id=""> <label for="">Blank</label>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="radio" name="" id=""> <label for="">Post Printing</label>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Handing Over:</label>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">?</label>
                                        </div>
                                        <div class="col-md-1">
                                             <label for="">Taking Over:</label>
                                        </div>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">?</label>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <select name="" class="form-control" id="">
                                                <option value="" selected disabled>Select Muccadum</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Combined:</label>
                                        <div class="col-md-1">
                                            <input type="radio" name="" id=""> <label for="">?</label>
                                        </div>
            ...
            <div class="modal fade " id="stockRegisterModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Stock Register</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
            ...
            <div class="row" style="padding: 5px 5px 9px 5px;">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-3" v-if="!isHold">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-md-5 col-form-label">Delivered: </label>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                        aria-controls="home" aria-selected="true">Job Details</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="stock-tab" data-toggle="tab" href="#stock" role="tab" aria-controls="stock"
                        aria-selected="false">Opening Stock</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="invoice-tab" data-toggle="tab" href="#invoice" role="tab"
                        aria-controls="invoice" aria-selected="false">Invoice(s) & D/O(s)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="godown-tab" data-toggle="tab" href="#godown" role="tab"
                        aria-controls="godown" aria-selected="false">Godown Keepers</a>
                </li>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-radio mb-5">
                                                            <input type="radio" v-model.trim="selected"
                                                                id="customRadio1" name="type" value="Bank"
                                                                class="custom-control-input">
                                                            <label class="custom-control-label"
                                                                for="customRadio1">Bank</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="custom-control  custom-radio mb-5">
                                                            <input type="radio" style="background-color:red !important"
                                                                ...
                                                                value="Customers" class="custom-control-input">
                                                            <label class="custom-control-label"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="custom-control custom-radio mb-5">
                                                            <input type="radio" v-model.trim="selected"
                                                                id="customRadio3" name="type" value="Vendors"
                                                                class="custom-control-input">
                                                            <label class="custom-control-label"
                                                ...
                                                <div v-if="$v.selected.$error">
                                                    <p class=" text-danger" v-if="!$v.selected.required">Please Select
                                                        this Option</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8 pl-0 pr-0">
                                                <Select id="company" label="text"
                                                    :class="[{'invalid':$v.company.$error},'mySelect']"
                                                    v-model="company" :options="companies"></Select>
                                                <div v-if="$v.company.$error">
                                                    <p class="text-danger" v-if="!$v.company.required">Select some
                                                        company</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-8 pl-0 pr-0">
                                                ...
                                                <div v-if="$v.region.$error">
                                                    <p class="text-danger" v-if="!$v.region.required">Select your region
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="section2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.vendor.$error">
                                                        <p class=" text-danger" v-if="!$v.vendor.required">Please Select
                                                            some vendor</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.vendorAddress.$error">
                                                        <p class=" text-danger" v-if="!$v.vendorAddress.required">Please
                                                            input vendor billing address</p>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.vendorRepresent.$error">
                                                        <p class=" text-danger" v-if="!$v.vendorRepresent.required">
                                                            Please input vendor representative</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    <input class="form-control  form-control-sm"
                                                        v-model="vendorDesignation"
                                                        :class="{'date-invalid':$v.vendorDesignation.$error}"
                                                        type="text">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.vendorPhone.$error">
                                                        <p class=" text-danger" v-if="!$v.vendorPhone.required">Please
                                                            input vendor phone-number</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.vendorEmail.$error">
                                                        <p class=" text-danger" v-if="!$v.vendorEmail.required">Please
                                                            input vendor email address</p>
                                                        <p class="text-danger" v-if="!$v.vendorEmail.email">Please fill
                                                            out valid email</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3 pl-0">
                                                    ...
                                                    <div v-if="$v.vendorLetter.$error">
                                                        <p class=" text-danger" v-if="!$v.vendorLetter.required">Please
                                                            input vendor letter</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div v-if="$v.vendorExpiry.$error" style="margin-left:20px">
                                                        <p class=" text-danger" v-if="!$v.vendorExpiry.required">Please
                                                            fill out the date</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset id="section1" v-show="selected == 'Bank'">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5" style="padding-left:0px">
                                                    ...
                                                    <div v-if="$v.selectedBank.$error">
                                                        <p class="text-danger" v-if="!$v.selectedBank.required">Please
                                                            select some bank</p>
                                                    </div>
                                                </div>
                                                <div class=" col-md-2 ">
                                            ...
                                            <div class="modal fade bd-example-modal-2" id="bankModal" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Add new Bank
                                                            </h5>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div v-if="$v.bankName1.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.bankName1.required">Please
                                                                                input bank name</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div v-if="$v.bankType.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.bankType.required">Please
                                                                                select bank type</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div v-if="$v.bankCode1.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.bankCode1.required">Please
                                                                                input bank code</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div v-if="$v.bankIbr.$error">
                                                                                <p class="text-danger"
                                                                                    v-if="!$v.bankIbr.required">Please
                                                                                    input bank IBR rate</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <input type="number" v-model="selectedBranch" id="branchId" :disabled="!selectedBank"  @input="getBranchById()"  class="form-control ">
                                                ...
                                                <div class="col-md-7 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.bankBranch.$error">
                                                        <p class="text-danger" v-if="!$v.bankBranch.required">Please
                                                            select some branch</p>
                                                    </div>
                                                </div>
                                                                ...
                                                                <form enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div v-if="$v.branchName.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.branchName.required">Please
                                                                                input branch Name</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div v-if="$v.branchCity.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.branchCity.required">Please
                                                                                select branch city</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Complete
                                                                            Address:</label>
                                                                        ...
                                                                        <div v-if="$v.branchAddress.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.branchAddress.required">Please
                                                                                select branch complete address</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Landline
                                                                            Number:</label>
                                                                        ...
                                                                        <div v-if="$v.branchLandline.$error">
                                                                            <p class="text-danger"
                                                                                ...
                                                                                Please input landline number</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    <textarea type="text" name="" v-model="billingAddress"
                                                        :class="{'date-invalid':$v.billingAddress.$error}" cols="30"
                                                        rows="2" class=" form-control form-control-sm"
                                                        style="height:60px"></textarea>
                                                    <div v-if="$v.billingAddress.$error">
                                                        <p class="text-danger" v-if="!$v.billingAddress.required">Please
                                                            fill out billing address</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    <input class="form-control  form-control-sm"
                                                        v-model="bankRepresentative"
                                                        :class="{'date-invalid':$v.bankRepresentative.$error}"
                                                        type="text">
                                                    <div v-if="$v.bankRepresentative.$error">
                                                        <p class="text-danger" v-if="!$v.bankRepresentative.required">
                                                            Please fill out representative</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.bankDesignation.$error">
                                                        <p class="text-danger" v-if="!$v.bankDesignation.required">
                                                            Please fill out designation and department</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.bankPhone.$error">
                                                        <p class="text-danger" v-if="!$v.bankPhone.required">Please fill
                                                            out phone number</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input class="form-control  form-control-sm col-md-8"
                                                    v-model="ibrBranchFax" type="text">
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.bankEmail.$error">
                                                        <p class="text-danger" v-if="!$v.bankEmail.required">Please fill
                                                            out email address</p>
                                                        <p class="text-danger" v-if="!$v.bankEmail.email">Please fill
                                                            out valid email</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3 pl-0">
                                                    ...
                                                    <div v-if="$v.bankletterNo.$error">
                                                        <p class="text-danger" v-if="!$v.bankletterNo.required">Please
                                        ...
                                        <fieldset id="section2" v-show="selected == 'Customers' || 'Vendors' || 'Bank'">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7 pl-0">
                                                    <Select :options="customers"
                                                        ...
                                                        @input="getCustomer()" v-model="customerName"
                                                        label="text"></Select>
                                                    <div v-if="$v.customerName.$error">
                                                        <p class="text-danger" v-if="!$v.customerName.required">Please
                                                            select Customer</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-2" style="padding-left:0px !important">
                                                    <input type="button" class="btn btn-primary branch-btn"
                                                        data-toggle="modal" data-target="#customerModal"
                                                        style="margin-left:16px;font-size:12px" value="Add">
                                                </div>
                                            </div>
                                            <div class="modal fade bd-example-modal-2" tabindex="-1" role="dialog"
                                                id="customerModal" aria-labelledby="myLargeModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <form enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div v-if="$v.customerName1.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.customerName1.required">Please
                                                                                input customer name</p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label for="message-text"
                                                                        ...
                                                                        <div v-if="$v.customerCode1.$error">
                                                                            <p class="text-danger"
                                                                                v-if="!$v.customerCode1.required">Please
                                                                                input customer code</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div v-if="$v.customerCity.$error">
                                                                        <p class="text-danger"
                                                                            v-if="!$v.customerCity.required">Please
                                                                            input customer city</p>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="recipient-name"
                                                                        class="col-form-label">Address:</label>
                                                                    <input v-model="customerAddress1"
                                                                        class="form-control"
                                                                        :class="{'date-invalid':$v.customerAddress1.$error}">
                                                                    <div v-if="$v.customerAddress1.$error">
                                                                        <p class="text-danger"
                                                                            v-if="!$v.customerAddress1.required">Please
                                                                            input customer address</p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div v-if="$v.customerFax1.$error">
                                                                                <p class="text-danger"
                                                                                    ...
                                                                                    Please input customer fax number</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    <input class="form-control form-control-sm"
                                                        :class="{'date-invalid':$v.customerRepresent.$error}"
                                                        type="text" v-model="customerRepresent">
                                                    <div v-if="$v.customerRepresent.$error">
                                                        <p class="text-danger" v-if="!$v.customerRepresent.required">
                                                            Please input customer representative</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.customerDesignation.$error">
                                                        <p class="text-danger" v-if="!$v.customerDesignation.required">
                                                            Please input customer designation</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.customerPhone.$error">
                                                        <p class="text-danger" v-if="!$v.customerPhone.required">Please
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8 pl-0 pr-0">
                                                    ...
                                                    <div v-if="$v.customerEmail.$error">
                                                        <p class="text-danger" v-if="!$v.customerEmail.required">Please
                                                            input customer email address</p>
                                                        <p class="text-danger" v-if="!$v.customerEmail.email">Please
                                                            input valid email address</p>
                                ...
                                <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group row">
                                            <label for="newName" class="col-md-3 col-form-label">Godown/Vessel</label>
                                            <div class="col-md-3">
                                                <input type="text" class="form-control cus_input" id="" name=""
                                                    value="">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="checkbox" name="bond" id="bond">
                                        ...
                                        <div class="form-group row">
                                            <label for="newName" class="col-md-3 col-form-label">Address</label>
                                            <div class="col-md-9">
                                                <textarea class="form-control" style="height: 50px;" name="" id=""
                                                    cols="42" rows="1"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 form-label">Taken On: </label>
                                            <div class="col-md-4 pl-3">
                                                <input class="form-control form-control-sm" name="" type="date">

                                            </div>
                                            <label class="col-md-2 form-label">1st Bill: </label>
                                            <div class="col-md-3 pl-0">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 form-label">Close On: </label>
                                            <div class="col-md-4 pl-3">
                                                <input class="form-control form-control-sm" name="" type="date">

                                            </div>
                                            <label class="col-md-2 form-label">Last Bill: </label>
                                            <div class="col-md-3 pl-0">
                                                <input class="form-control form-control-sm" name="" type="text">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4 pl-3">
                                                <input class="form-control form-control-sm" v-model="serviceCharge" name="" type="text">
 
                                            </div>
                                            <label class="col-md-2 form-label">F.E.D: </label>
                                            <div class="col-md-3 pl-0">
                                                <input class="form-control form-control-sm" name="" type="text">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Portfolio</label>
                                            <div class="col-md-2 custom-control custom-radio "
                                                style="padding: 5px 15px;">
                                                <input type="radio" name="" class="custom-radio" id=""> <label
                                                    for="">SME</label>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Insurance Co</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Policy No</label>
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" name="" id="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 form-label">Sum Insured
                                                (in millions): </label>
                                            <div class="col-md-4 pl-3">
                                                <input class="form-control form-control-sm" name="" type="text">

                                            </div>
                                            <label class="col-md-2 form-label">Expiry Date: </label>
                                            <div class="col-md-3 pl-0">
                                                <input class="form-control form-control-sm" name="" type="date">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Limit:</label>
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" name="" id="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Supervisor:</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">Job Remarks:</label>
                                            <div class="col-md-9">
                                                <textarea class="form-control" style="height: 50px;" name="" id=""
                                                    cols="42" rows="1"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label">FootNote/Godown
                                                Keepers:</label>
                                            <div class="col-md-9">
                                                <textarea class="form-control" style="height: 50px;" name="" id=""
                                                    cols="42" rows="1"></textarea>
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-md-3 col-form-label"></label>
                                            <div class="col-md-9">
                                                <input type="checkbox" name="" id=""> <label for="">Print Weight with
                                                    Quantity</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Weight
                                                    Separately</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print D/O Nos in
                                                    Stcok Report</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Total in Stock
                                                    Report</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Item then
                                                    L/C</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Ship
                                                    Breaking</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print LoT
                                                    Details</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Annexured
                                                    Report</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Bank
                                                    Logo</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Value for
                                                    NIB</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Total on First
                                                    Page</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print Godown
                                                    Keeper(s) on Stock Report</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print
                                                    Aging</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Islamic Asset
                                                    Management</label><br>
                                                <input type="checkbox" name="" id=""> <label for="">Print with Landed
                                                    Cost</label>
                                            </div>
                                        </div>
                                        <div class="form-group row" style="padding-right:30px">
                                            <div class="col-md-12">
                                                ...
                                                <a href=""><input type="button" class="btn btn-primary"
                                                        style="float:right;margin:10px" value="Cancel"></a>
                                                <input type="button" @click="onComplete()" v-if="!saveButton"
                                                    style="float:right;margin:10px" class="btn btn-primary"
                                                    value="Save">
                    ...
                    <div class="modal fade bd-example-modal-2" id="billModal" tabindex="-1" role="dialog"
                        aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    ...
                                    <iframe :src="bill" width="100%" v-show="!loading" height="550px"
                ...
                <div class="tab-pane fade" id="stock" role="tabpanel" aria-labelledby="stock-tab">
                    <div style="border: 2px solid #275129;margin: 0px;padding: 33px;" class="wizard-content pt-4">
                        <a href="#"><button class="btn btn-success"><i class="fa fa-plus pr-2"></i>New Item</button></a>
                        <br>
                ...
                <div class="tab-pane fade" id="godown" role="tabpanel" aria-labelledby="godown-tab">
                    <div style="border: 2px solid #275129;margin: 0px;padding: 33px;" class="wizard-content pt-4">
                        <a href="#"><button class="btn btn-success"><i class="fa fa-plus pr-2"></i>Hire Godown
                                Keeper</button></a>
                        <a href="#"><button class="btn btn-success"><i class="fa fa-plus pr-2"></i>Re-Hire Godown
                                Keeper</button></a>
                        <a href="#"><button class="btn btn-success"><i class="fa fa-plus pr-2"></i>Attach Hired Godown
                                Keeper</button></a>
                        <br>
                        <table class="table display" id="myTable1">
                            <thead class="thead-dark">
            ...
            <div class="row">
                ...
                <div class="col-md-12" style="text-align:right;margin-top:10px">
                    <input type="button" @click="onComplete()" class="btn btn-primary"  value="Save">
                    <a href="/inspection"><input type="button" class="btn btn-primary" value="Ignore"></a>
                    <a href="#"><input type="button" class="btn btn-primary" value="Comments"></a>
                    <a href="#"><input type="button" class="btn btn-primary" value="Send Confirmation Email"></a>
                </div>
...
<script>
    ...
    // import LivestockReport from './Report/LivestockReport.vue'
    ...
    export default {
        ...
        components: {
            ...
            //   'livestock-report':LivestockReport,
            Autocomplete
        },
        data() {
            return {
                ...
                declaredCurrency: '',
                declaredAmount: '',
                declaredCurrencyPrint: false,
                declaredCurrencyAttachments: false,
                declaredAsPer: '',
                declaredNoLabelInput: '',
                declaredNoLabelAttachments: false,
                declaredRemarks: '',
                declaredRemarksPrint: false,
                insuranceInsuredBy: '',
                insuranceFor: '',
                insuranceExpiry: '',
                insuranceWithBank: false,
                insuranceStatus: '',
                insuranceNoLabelInput: '',
                insuranceNextLine: false,
                insuranceRemarks: '',
                inspectioneStockInspector: '',
                inspectionNextLine: '',
                inspectionDate: '',
                inspectionReportDate: '',
                inspectionStockReportDate: '',
                bill: 0,
                loading: false,
                saveButton: false,
                printButton: false,
                letterModalIs: true,
                letterReportModalIs: true,
                stockRecevingModalIs: true,
                stockInsuranceModalIs: true,
                rateRevisionModalIs: true,
                stockReportModalIs: true,
                stockRegisterModalIs: true,
                siteAddress: '',
                loader: '',
                isHold: false,
                isCancalled: false,
        ...
        methods: {
            getJobById() {
                axios.get('/getMucJob/' + this.id)
                    .then(res => {
                        console.log(res.data);
                        res.data.job.forEach((obj) => {

                            this.company = {
                                text: obj.job_company,
                                value: obj.job_by
                            };
                            this.region = {
                                text: obj.region,
                            ...
                            this.operationalBranch = {
                                text: obj.op_branch,
                                value: obj.operational_branch
                            };
                            ...
                            this.mucName = {
                                text: obj.muc_name,
                                value: obj.muccaduum_id
                            };
                            this.mucRes = obj.muccaduum_representative;
                            this.mucResPrint = obj.is_print_representative === 1 ? true : false;
                            this.mucNIC = obj.muccaduum_representative_nic;
                            this.mucDesign = obj.muccaduum_representative_desig;
                            this.mucPhone = obj.muccaduum_representative_phone;
                            this.mucFax = obj.muccaduum_representative_fax;
                            this.mucEmail = obj.muccaduum_representative_email;
                            this.isRotation = obj.is_rotation === 1 ? true : false;
                            this.lastDateOf = obj.last_do;

                            this.declaredCurrency = obj.declared_currency;
                            this.declaredAmount = obj.declared_amount;
                            this.declaredCurrencyPrint = obj.declared_currency_print === 1 ? true : false;
                            this.declaredCurrencyAttachments = obj.declared_currency_attachments === 1 ? true : false;
                            this.declaredAsPer = obj.declared_as_per;
                            this.declaredNoLabelInput = obj.declared_no_label_input;
                            this.declaredNoLabelAttachments = obj.declared_no_label_attachments === 1 ? true : false;
                            this.declaredRemarksPrint = obj.declared_remarks_print === 1 ? true : false;
                            this.declaredRemarks = obj.declared_remarks;


                            this.insuranceInsuredBy = obj.insurance_insured_by;
                            this.insuranceFor = obj.insurance_insurance_for;
                            this.insuranceExpiry = obj.insurance_expiry;
                            this.insuranceStatus = obj.insurance_status;
                            this.insuranceWithBank = obj.is_insurance_with_bank === 1 ? true : false;
                            this.insuranceNoLabelInput = obj.insurance_no_label_input;
                            this.insuranceNextLine = obj.insurance_next_line === 1 ? true : false;
                            this.insuranceRemarks = obj.insurance_remarks;

                            this.inspectioneStockInspector = obj.inspection_stock_inspector;
                            this.inspectionNextLine = obj.inspection_next_line === 1 ? true : false;
                            this.inspectionDate = obj.inspection_date;
                            this.inspectionReportDate = obj.inspection_report_date;
                            this.inspectionStockReportDate = obj.inspection_stock_report_date;


                            this.conductedBy = {
                                text: obj.employee_name,
                                value: obj.conducted_by
                            };
                            this.signedBy = {
                                text: obj.signed_by
                            };

                            this.isJoint = obj.is_stock_joint === 1 ? true : false;
                            this.stockSelected = obj.stock_is;

                            this.requestedOn = obj.request_date;
                            this.siteStart = obj.site_start;
                            this.facility = JSON.parse(obj.facility_id);
                            this.isPrintFacility = obj.is_facility_print === 1 ? true : false;
                            this.sanctionedNo = obj.sactioned_limit;
                            this.scopeIs = obj.scope;
                            this.collateral = obj.collateral;
                            this.quantity = obj.quantity;
                            this.ownershipEvidence = obj.ownership_evidance;
                            this.serviceCharge = obj.service_charges;
                            this.isCorporate = obj.is_service_charges_corporate;
                            this.isSalesTax = obj.is_sales_tax === 1 ? true : false;
                            this.isTravelCharges = obj.is_travel_charges === 1 ? true : false;
                            this.travelCharges = obj.travel_charges;
                            ...
                            this.siteAddress = obj.customer_address;
            ...
            onComplete: function() {
                ...
                axios.put('/updateMuccaddum/' + this.id, {
                        ...
                        show_values: this.isShowValues,
                        letter_head: this.isLetterHead,
                        completed: this.isCompleted,
                        delivered_on: this.delivedOn,
                        // prepared_by_cpu: this.prepByCpu,
                        // is_joint: this.isJoint,
                        // stock_selected: this.stockSelected,
                        // requested_on: this.requestedOn,
                        // site_start: this.siteStart,
                        // facility_id: this.facility,
                        // is_facility_print: this.isPrintFacility,
                        // sactioned_limit: this.sanctionedNo,
                        // scope: this.scope,
                        // collateral: this.collateral,
                        // quantity: this.quantity,
                        // ownership_evidance: this.ownershipEvidence,
                        service_charges: this.serviceCharge,
                        // is_service_charges_corporate: this.isCorporate,
                        // is_sales_tax: this.isSalesTax,
                        // sale_reg: this.saleReg.value,
                        // muccaduum_id: this.mucName.value,
                        // is_print_muccaduum: this.mucPrint,
                        // is_print_representative: this.mucResPrint,
                        // muccaduum_representative: this.mucRes,
                        // muccaduum_representative_nic: this.mucNIC,
                        // muccaduum_representative_desig: this.mucDesign,
                        // muccaduum_representative_phone: this.mucPhone,
                        // muccaduum_representative_fax: this.mucFax,
                        // muccaduum_representative_email: this.mucEmail,
                        // is_rotation: this.isRotation,
                        // last_do: this.lastDateOf,
                        // declared_currency: this.declaredCurrency,
                        // declared_amount: this.declaredAmount,
                        // declared_currency_print: this.declaredCurrencyPrint,
                        // declared_currency_print_attachments: this.declaredCurrencyAttachments,
                        // declared_as_per: this.declaredAsPer,
                        // declared_no_label_input: this.declaredNoLabelInput,
                        // declared_no_label_attachments: this.declaredNoLabelAttachments,
                        // declared_remarks: this.declaredRemarks,
                        // declared_remarks_print: this.declaredRemarksPrint,
                        // insurance_insured_by: this.insuranceInsuredBy,
                        // insurance_insurance_for: this.insuranceFor,
                        // insurance_expiry: this.insuranceExpiry,
                        // is_insurance_with_bank: this.insuranceWithBank,
                        // insurance_status: this.insuranceStatus,
                        // insurance_no_label_input: this.insuranceNoLabelInput,
                        // insurance_next_line: this.insuranceNextLine,
                        // insurance_remarks: this.insuranceRemarks,
                        // inspection_stock_inspector: this.inspectioneStockInspector,
                        // inspection_next_line: this.inspectionNextLine,
                        // inspection_date: this.inspectionDate,
                        // inspection_report_date: this.inspectionReportDate,
                        // inspection_stock_report_date: this.inspectionStockReportDate,
                        // conducted_by: this.conductedBy.value,
                        // signed_by: this.signedBy.text,
                        // is_travel_charges: this.isTravelCharges,
                        // travel_charges: this.travelCharges,
            ...
            checkTravel() {
                ...
                var travel = this.isTravelCharges;
            ...
            cancelJob: function() {
                ...
                axios.put('/cancelInspection/' + this.id, {
            ...
            holdJob: function() {
                ...
                axios.put('/holdInspection/' + this.id, {
            ...
            printInsBill() {
                ...
                this.loading = true;
                axios.post('/printMucBill', billData, {
