<template>
  <div class="container">
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
      <a href="/valuation" class="btn btn-primary">Back</a>

      <div class="clearfix">
        <h4 class="text-blue pt-3">Valuation</h4>
        <p class="mb-30 font-14">New Valuation Job</p>
      ...
      <div class="wizard-content">
        <form action="" >
                    ...
                    <div class="form-group row">
                          <label class="col-md-3 col-form-label">Category: </label>
                                <div class="col-md-6 pl-0 pr-0">
                                    <Select  label="text" @input="getBranches()"  :class="{'date-invalid':$v.subcategory.$error}" :options="subcategories"  v-model="subcategory"></Select>
            ...
            <a href="/valuation"><input type="button"  class="btn btn-primary" value="Cancel"></a>
        </form>  
      </div>
    </div>
  </div>
  ...
  export default {
   ...
   postdata(){
       ...
       var eddate=this.edd.getFullYear()+"-"+month+"-"+this.edd.getDate();
        ...
        is_salesTax:this.isSalesTax,
        is_full:this.isFull,
        out_of_pockets:this.outOfPockets,
        is_cpu:this.isBycpu,
        asset_class:this.assetClass,
        no_of_pages:this.noOfPages,
        survey_team:this.surveyTeam,
        dc_team:this.dcTeam,
        sign_team:this.signTeam,
        // car_team:this.carMake,
        // car_reg_no:this.carRegNo,
        // car_engine_no:this.carEngineNo,
        // car_chassis_no:this.carChassisNo,
        ...
        axios.post('/api/addValuationJob',jobData,{
            headers:headers
        })
            .then(res=>{
