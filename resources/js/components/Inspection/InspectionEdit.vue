    ...
    <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
        ...
        <div class="clearfix"  >
            <div class="row" style="background-color:#275129;padding-bottom:15px">
                <div class="col-md-10">
                    <h4 class="text-white  pt-3">Edit Inspection Job</h4>
                </div>
                <div class="col-md-2" style="text-align: right;">
                      <a href="/inspection" style="margin-top: 12px;margin-left: 50px;
                      color: black;
        ...
        <div class="row" style="padding: 5px 5px 9px 5px;">
            ...
            <div class="col-md-12" style="text-align:left;">
                        <div class="row" style="float:left">
                            <input type="button" v-on:click="reportModalIs=false"  class="btn btn-primary " data-toggle="modal" data-target="#reportModal" style="margin-left: 10px;margin-right: 10px;" value="Print Report">
                            <a href="#"><input type="button"  class="btn btn-primary " style="margin-right: 10px;" value="Print Front Page"></a>
                            <a href="#"><input type="button"  class="btn btn-primary " style="margin-right: 31px;" value="Print Annexure"></a>
            ...
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Inspection - Report Details</h5>
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="comment-tab" data-toggle="tab" href="#comment" role="tab" aria-controls="comment" aria-selected="false">Comments / Remarks</a>
            </li>
                        ...
                        <div id="section2">
                            <fieldset id="section3"  v-show="selected == 'Vendors'">
                                    ...
                                    <fieldset id="section1" v-show="selected == 'Bank'">
                                        ...
                                        <br>
                                            ...
                                            <div class="col-md-1 pr-0">
                                            <input type="button" value="Add" class="btn btn-primary "  data-toggle="modal" data-target="#bankModal" style="font-size:12px" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <Select  label="text" v-model="bankBranch" @input="getAddress()" :class="[{'date-invalid':$v.bankBranch.$error},'mySelect']"  :disabled="!selectedBank" :options="branches" ></Select>
                                            <!--  -->
                                            ...
                                            <div class="col-md-2" style="padding-left:15px !important">
                                                <input type="button" value="Add" class="btn btn-primary branch-btn " :disabled="!selectedBank" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-left:16px;font-size:12px">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Representative: </label>
                                            <div class="col-md-8 pl-0 pr-0" >
                                                <Select v-model="bankRepresentative"  @input="getRepDetails()" :class="[{'date-invalid':$v.bankRepresentative.$error},'mySelect']" taggable :options="representatives" label="text"></Select>
                                    ...
                                    <fieldset id="section2"  v-show="selected == 'Customers' || 'Vendors' || 'Bank'">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <Select :options="customers" :class="[{'date-invalid':$v.customerName.$error},'mySelect']" @input="getCustomer()" v-model="customerName" label="text" ></Select>
                                            <div v-if="$v.customerName.$error" >
                                                    <p class="text-danger" v-if="!$v.customerName.required">Please select Customer</p>
                                            </div>
                                                </div>
                                                <div class="col-md-2" style="padding-left:0px !important">
                                                <input type="button" class="btn btn-primary branch-btn" data-toggle="modal" data-target="#customerModal" style="margin-left:16px;font-size:12px" value="Add">
                                                </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 form-label">Stock's Type: </label>

                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class=" col-md-3" style="padding-left:35px" >
                                                <div class="form-check  islamic-check">
                                                    <input type="checkbox" class="form-check-input" v-model="isJoint" >
                                                    <label for="form-check-label"> Joint?</label>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class=" mb-5">
                                                <input type="radio" v-model.trim="stockSelected"    value="Hypothecated"  >
                                                <label class="" for="customRadio1">Hypothecated</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" mb-5">
                                                <input type="radio" style="background-color:red !important" v-model.trim="stockSelected"   value="Pledged" >
                                                <label class=""  for="customRadio2">Pledged</label>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class=" col-md-3 " >
                                                <div class=" mb-5">
                                                <input type="radio" v-model.trim="stockSelected"  value="Istisna">
                                                <label class="" for="customRadio1">Istisna</label>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class=" mb-5">
                                                <input type="radio" v-model.trim="stockSelected" value="Murabaha"  >
                                                <label class="" for="customRadio1">Murabaha</label>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class=" mb-5">
                                                <input type="radio" style="background-color:red !important" v-model.trim="stockSelected"  value="Salam"  >
                                                <label class=""  for="customRadio2">Salam</label>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class=" ">
                                                <input type="radio" style="background-color:red !important" v-model.trim="stockSelected"   value="L/Stock" >
                                                <label class=""  for="customRadio2">L/Stock</label>
                                                </div>
                                            </div>
                                ...
                                <div class="mcdm-section" v-show="stockSelected == 'Pledged'">
                                    <h5 style="padding-bottom:30px">Muccadum Details</h5>
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                            <Select  label="text" v-model="mucName" :options="muccaduums" :class="['mySelect']"    ></Select>
                                            <!--  -->
                                            </div>
                                            <div class="col-md-1" style="padding-left:0px !important">
                                                <input type="button" value="Add" class="btn btn-primary branch-btn "  data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-left:16px">
                                            </div>
                                            <div class="col-md-3" style="padding-left:26px !important">
                                                <div class="form-check mt-2 ml-4 islamic-check">
                                                    <input type="checkbox" class="form-check-input" v-model="mucPrint" >
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">Representative(S): </label>
                                        <div class="col-md-7" >
                                            <textarea v-model="mucRes"  cols="30" rows="2" class="form-control form-control-sm" style="height:60px" :class="{'date-invalid':$v.vendorAddress.$error}" ></textarea>
                                            <div v-if="$v.vendorAddress.$error">
                                                <p class=" text-danger" v-if="!$v.vendorAddress.required">Please input vendor billing address</p>
                                            </div>
                                        </div>
                                        <div class="col-md-2" style="padding-left:0px !important">
                                                <div class="form-check mt-2 ml-4 islamic-check">
                                                    <input type="checkbox" class="form-check-input" v-model="mucResPrint" >
                                                    <label for="form-check-label"> Print ?</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-md-3 col-form-label">NIC #: </label>
                                        <div class="col-md-8 pr-0 pl-0" >
                                            <textarea v-model="mucNIC"  cols="30" rows="2" class="form-control form-control-sm" style="height:60px" :class="{'date-invalid':$v.vendorAddress.$error}" ></textarea>
                                            <div v-if="$v.vendorAddress.$error">
                                                <p class=" text-danger" v-if="!$v.vendorAddress.required">Please input vendor billing address</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                                    <label class="col-md-3 col-form-label">Desig/Dept: </label>
                                                    <div class="col-md-8 pl-0 pr-0" >
                                                        <input class="form-control  form-control-sm" v-model="mucDesign" :class="{'date-invalid':$v.vendorDesignation.$error}"  type="text">
                                                            <div v-if="$v.vendorDesignation.$error">
                                                            <p class=" text-danger" v-if="!$v.vendorDesignation.required">Please input vendor representative</p>
                                                            </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label">Phone: </label>
                                                    <div class="col-md-8 pl-0 pr-0">
                                                        <input type="number" class="form-control  form-control-sm" v-model="mucPhone" :class="{'date-invalid':$v.vendorPhone.$error}"  >
                                                        <div v-if="$v.vendorPhone.$error">
                                                            <p class=" text-danger" v-if="!$v.vendorPhone.required">Please input vendor phone-number</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label">Fax: </label>
                                                    <div class="col-md-8 pl-0 pr-0"  >
                                                        <input  class="form-control  form-control-sm "  v-model="mucPhone"  type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 col-form-label">Email: </label>
                                                    <div class="col-md-8 pl-0 pr-0">
                                                        <input type="email" class="form-control  form-control-sm" v-model="mucEmail" :class="{'date-invalid':$v.vendorEmail.$error}" >
                                                        <div v-if="$v.vendorEmail.$error">
                                                            <p class=" text-danger" v-if="!$v.vendorEmail.required">Please input vendor email address</p>
                                                            <p class="text-danger" v-if="!$v.vendorEmail.email">Please fill out valid email</p>
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 form-label">Rotation: </label>
                                                    <div class="col-md-2" >
                                                        <div class="form-check  ml-4 islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="isRotation" >
                                                            <label for="form-check-label"> ? </label>
                                                        </div>
                                                    </div>

                                                    <label class="col-md-2 form-label">Last D/O: </label>
                                                    <div class="col-md-2" >
                                                        <input class="form-control form-control-sm" v-model="lastDateOf"   style="margin-left: 18px;min-width: 154px;" name="txtDate1" type="date">
                                ...
                                <div class="section-2">
                                    <h5 style="padding-bottom:30px">Job Details</h5>

                                    <div class="form-group row">

                                        <label class="col-md-3 form-label">Requested On: </label>
                                            <div class="col-md-3 pl-0" >
                                                <input class="form-control form-control-sm" v-model="requestedOn"    name="txtDate1" type="date">

                                            </div>
                                            <label class="col-md-2 form-label">Site Start: </label>
                                            <div class="col-md-3 pl-0" >
                                                <input class="form-control form-control-sm" v-model="siteStart"   name="txtDate1" type="date">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-5" style="padding-left:0px">
                                                <input oninput="this.value = Math.abs(this.value)" type="number" v-model="serviceCharge" class="form-control form-control-sm">
                                            </div>
                                            <div class=" col-md-4" >
                                                <div class="form-check mt-2 ml-4 islamic-check">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-2" >
                                                <div class="form-check mt-2 ml-4 islamic-check">
                                                    <input type="checkbox" class="form-check-input" @click="checkSaleReg()" v-model="isSalesTax" >
                                                    <label for="form-check-label"> ? </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                                <label class="col-md-3 col-form-label">Traveling Charges: </label>
                                                <div class="col-md-2" >
                                                    <div class="form-check mt-2 ml-4 islamic-check">
                                                        <input type="checkbox" class="form-check-input" @click="checkTravel()" v-model="isTravelCharges" >
                                                        <label for="form-check-label"> ? </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" style="padding-left:0px" v-show="isTravelCharges==true">

                                                <input oninput="this.value = Math.abs(this.value)" class="form-control form-control-sm" v-model="travelCharges" type="number">
                                ...
                                <hr style="background-color:#275129">
                                <div class="section-3">
                                    <h5 style="padding-bottom:30px">Declared Value</h5>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control  form-control-sm" v-model="declaredCurrency"  >

                                                    </div>
                                                    <label class="col-md-2 form-label">Amount: </label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control  form-control-sm" v-model="declaredAmount"  >

                                                    </div>
                                                    <div class=" col-md-2" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="declaredCurrencyPrint" >
                                                            <label for="form-check-label"> Print</label>
                                                        </div>
                                                    </div>
                                                    <div class=" col-md-2" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="declaredCurrencyAttachments" >
                                                            <label for="form-check-label"> Attachments</label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-md-3 form-label">As per</label>

                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class=" col-md-3 " >
                                                    <div class=" mb-5">
                                                    <input type="radio" v-model="declaredAsPer"  value="None">
                                                    <label class="" for="customRadio1">None</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class=" mb-5">
                                                    <input type="radio" v-model="declaredAsPer" value="Declaration"  >
                                                    <label class="" for="customRadio1">Declaration</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class=" mb-5">
                                                    <input type="radio" style="background-color:red !important" v-model="declaredAsPer"  value="Stock Report"  >
                                                    <label class=""  for="customRadio2">Stock Report</label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                <input type="text" class="form-control  form-control-sm" v-model="declaredNoLabelInput"  >

                                                </div>
                                                 <div class=" col-md-2" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="declaredNoLabelAttachments" >
                                                            <label for="form-check-label"> Attachments</label>
                                                        </div>
                                                </div>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                <textarea style="height:60px" class="form-control  form-control-sm" v-model="declaredRemarks"></textarea>

                                                </div>
                                                 <div class=" col-md-2" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="declaredRemarksPrint" >
                                                            <label for="form-check-label"> Print</label>
                                                        </div>
                                                </div>
                                ...
                                <hr style="background-color:#275129">
                                 <div class="section-4">
                                    <h5 style="padding-bottom:30px">Insurance Details</h5>
                                    <div class="form-group row">

                                        <label class="col-md-3 form-label">Insured By</label>

                                        <div class="col-md-8">
                                            <div class="row">
                                                <input type="text" class="form-control  form-control-sm" v-model="insuranceInsuredBy"  >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-md-3 form-label">Insurance For: </label>

                                        <div class="col-md-9">
                                                <div class="row" >
                                                    <div class="col-md-3 pl-0" >
                                                        <input type="text" class="form-control  form-control-sm" v-model="insuranceFor"  >

                                                    </div>
                                                    <label class="col-md-2 form-label">Expiry: </label>
                                                    <div class="col-md-6">
                                                        <input type="date" class="form-control  form-control-sm" v-model="insuranceExpiry"  >
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                 ...
                                                 <div class=" col-md-8" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="insuranceWithBank" >
                                                            <label for="form-check-label"> Insurance With the Bank?</label>
                                                        </div>
                                                </div>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                <div class=" col-md-3 " >
                                                    <div class=" mb-5">
                                                    <input type="radio" v-model.trim="insuranceStatus"  value="None">
                                                    <label class="" for="customRadio1">None</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class=" mb-5">
                                                    <input type="radio" v-model.trim="insuranceStatus" value="Satisfactory"  >
                                                    <label class="" for="customRadio1">Satisfactory</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class=" mb-5">
                                                    <input type="radio" style="background-color:red !important" v-model.trim="insuranceStatus"  value="Un-Satisfactory"  >
                                                    <label class=""  for="customRadio2">Un-Satisfactory</label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="row">
                                                ...
                                                <input type="text" class="form-control  form-control-sm" v-model="insuranceNoLabelInput"   >

                                                </div>
                                                 <div class=" col-md-3" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="insuranceNextLine" >
                                                            <label for="form-check-label"> Next Line</label>
                                                        </div>
                                                </div>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-md-9 pl-0">
                                            <div class="row">
                                                ...
                                                <div class="col-md-11">
                                                <textarea style="height:60px" class="form-control  form-control-sm" v-model="insuranceRemarks"></textarea>
                                ...
                                <hr style="background-color:#275129">
                                 <div class="section-5">
                                    <h5 style="padding-bottom:30px">Inspection Details</h5>
                                    <div class="form-group row">

                                        <label class="col-md-3 form-label">Stock Inspector</label>

                                        <div class="col-md-9">
                                            <div class="row">

                                                <div class="col-md-8 pl-0">
                                                <input type="text" class="form-control  form-control-sm" v-model="inspectioneStockInspector" :class="{'date-invalid':$v.vendorPhone.$error}"  >

                                                </div>
                                                 <div class=" col-md-3" style="padding-left:35px" >
                                                        <div class="form-check  islamic-check">
                                                            <input type="checkbox" class="form-check-input" v-model="inspectionNextLine" >
                                                            <label for="form-check-label"> Next Line</label>
                                                        </div>
                                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-md-3 form-label">Inspection Date: </label>

                                        <div class="col-md-9 pl-0">
                                            <div class="row">

                                                <div class="col-md-11">
                                                <textarea style="height:60px" class="form-control  form-control-sm" v-model="inspectionDate"  ></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-md-3 form-label">Report Date : </label>

                                        <div class="col-md-9">
                                                <div class="row" >
                                                    <div class="col-md-3 pl-0" >
                                                        <input type="date" class="form-control  form-control-sm" v-model="inspectionReportDate"   >

                                                    </div>
                                                    <label class="col-md-4 form-label">Stock Report Date: </label>
                                                    <div class="col-md-4">
                                                        <input type="text" class="form-control  form-control-sm" v-model="inspectionStockReportDate"   >
                                ...
                                <div class="section-6">
                                    ...
                                    <div class="form-group row ">
                                        ...
                                        <div class="col-md-8 pl-0 pr-0">
                                            <Select  label="text" :class="['mySelect']" v-model="conductedBy"  :options="conducters" ></Select>

                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                        <label class="col-md-3">Signed By: </label>
                                        <div class="col-md-8 pl-0 pr-0">
                                            <Select  label="text" :class="['mySelect']" v-model="signedBy"  :options="signers" ></Select>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" v-if="!saveButton" @click="cancelJob()" class="btn btn-primary" >Cancel Job</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-check" style="margin-top: 4px;">
                                    <input type="checkbox" class="form-check-input" :disabled="isCompleted "  v-model="isHold" >
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" v-if="!saveButton"  @click="holdJob()" class="btn btn-primary" >Save</button>
                    </div>
                </div>
            </div>
        </div>
...
import '@trevoreyre/autocomplete-vue/dist/style.css'
  export default {
    ...
    methods: {
     getInspectionJob(){
        axios.get('/getInspectionJob/' + this.id)
        .then(res=>{
            ...
            res.data.job.forEach((obj)=>{
                ...
                this.bankRepresentative={text:obj.bank_representative};
                ...
                this.mucName={text:obj.muc_name,value:obj.muccaduum_id};
                ...
                this.conductedBy={text:obj.employee_name,value:obj.conducted_by};
                this.signedBy={text:obj.signed_by};
   ...
   onComplete: function(){
        ...
        //  var cmpname=string.replace(/[{()}^0-9-]/g, "");
           ...
           axios.put('/updateInspection/' + this.id ,{
        ...
        bank_representative:this.bankRepresentative.text,
                 ...
                 axios.get('/api/getMuccadums',{
                    ...
                    .then(res=>{
                        res.data.forEach((obj)=>{
                            let text='';
                            let id='';
                            this.muccaduums.push({text:obj.muc_name,id:obj.id})
                        })
                    })
            },
    getFacilities(){
                 ...
                 axios.get('/api/getFacilities',{
                    ...
                    .then(res=>{
                        res.data.forEach((obj)=>{
                            let text='';
                            let id='';
                            this.facilites.push({text:obj.facility_name,id:obj.id})
                        })
                    })
            },
 ...
 getRepDetails(){
            ...
            const params={
                'representative':this.bankRepresentative.text
            };
            axios.get("/getBankRepresentativesDetails",{params}) //with id
                .then(res => {
    ...
    getAddress(){
            ...
            axios.get("/getBranchById/" + id) //with id
                ...
                console.log(error.response);
                     ...
                     axios.get("/getBankRepresentatives/" + id) //with id
                .then(res => {

                res.data.forEach((obj)=>{

                        this.representatives.push({text:obj.bank_representative});
                        // this.branch=obj.branch_name;
    ...
    printInsBill(){
        ...
        this.loading=true;
        axios.post('/printInsBill',billData,{responseType: 'arraybuffer'}).then(res=>{
