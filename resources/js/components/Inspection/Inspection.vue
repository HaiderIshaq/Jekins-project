    ...
    <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
      ...
      <div class="clearfix"  >
            <div class="row" style="background-color:#275129;padding-bottom:15px">
                <div class="col-md-10">
                    <h4 class="text-white  pt-3">New Inspection Job</h4>
                </div>
                        ...
                        <fieldset id="section1" v-show="selected == 'Bank'">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-2" style="padding-left:0px !important">
                                      <input type="button" value="Add" class="btn btn-primary branch-btn " :disabled="!selectedBank" data-toggle="modal" data-target=".bd-example-modal-lg" style="margin-left:16px">
                                </div>
                        ...
                        <fieldset id="section2"  v-show="selected == 'Customers' || 'Vendors' || 'Bank'">
                            ...
                            <div class="form-group row">
                                ...
                                <div v-if="$v.customerName.$error" >
                                    ...
                                    <div class="col-md-2" style="padding-left:0px !important">
                                    <input type="button" class="btn btn-primary branch-btn" data-toggle="modal" data-target="#customerModal" style="margin-left:16px" value="Add">
                                    </div>
                            </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-2" >
                                            <input class="form-control form-control-sm" v-model="lastDateOf" :class="{'date-invalid':$v.vendorExpiry.$error}"  style="margin-left: 18px;min-width: 154px;" name="txtDate1" type="date">
                                            <div v-if="$v.vendorExpiry.$error" style="margin-left:20px">
                                                <p class=" text-danger" v-if="!$v.vendorExpiry.required">Please fill out the date</p>
                                            </div>
                                        </div>
                    ...
                    <div class="section-2">
                        ...
                        <div class="form-group row">
                               ...
                               <label class="col-md-3 form-label">Requested On: </label>
                                ...
                                <div class="col-md-3 pl-0" >
                                    <input class="form-control form-control-sm" v-model="siteStart" :class="{'date-invalid':$v.vendorExpiry.$error}"   name="txtDate1" type="date">
                                    <div v-if="$v.vendorExpiry.$error" style="margin-left:20px">
                                        <p class=" text-danger" v-if="!$v.vendorExpiry.required">Please fill out the date</p>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-5" style="padding-left:0px">
                                    <input type="number" oninput="this.value = Math.abs(this.value)" v-model="serviceCharge" class="form-control form-control-sm">
                                </div>
                                <div class=" col-md-4" >
                                    <div class="form-check mt-2 ml-4 islamic-check">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-2" >
                                    <div class="form-check mt-2 ml-4 islamic-check">
                                        <input type="checkbox" class="form-check-input" v-model="isTravelCharges" >
                                        <label for="form-check-label"> ? </label>
                                    </div>
                                </div>
                                <div class="col-md-6" style="padding-left:0px" v-show="isTravelCharges==true">

                                <input class="form-control form-control-sm" oninput="this.value = Math.abs(this.value)" v-model="travelCharges" type="number">
  ...
  export default {
     ...
     data() {
       return {
        ...
        quantity:'',
        ownershipEvidence:'',
        facility:{"text":"Agri Finance","id":7},
        operationalBranch:'',
        serviceCharge:'',
        saveButton:false,
   ...
   if(this.selected=="Vendors")
    ...
    postdata(){
       ...
       var eddate=this.edd.getFullYear()+"-"+month+"-"+this.edd.getDate();
        ...
        is_stock_joint:this.isJoint,
        stock_is:this.stockSelected,
        muccaduum_id: this.mucName.id,
        is_print_muccaduum:this.mucPrint,
        is_print_representative:this.mucResPrin,
        ...
        axios.post('/api/addInspectionJob',jobData,{
            headers:headers
        })
            .then(res=>{
