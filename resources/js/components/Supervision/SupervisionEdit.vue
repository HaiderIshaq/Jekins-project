<template>
    ...
    <div class="container-fluid">
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">Edit Supervision Job</h4>
                    </div>
                ...
                <div class="col-md-12" style="text-align:left;">
                    <div class="row" style="float:left">
                        <input type="button" v-on:click="letterModal=false" class="btn btn-primary " data-toggle="modal"
                            data-target="#letterModal" style="margin-left: 10px;margin-right: 10px;" value="Print Letter(s)">
                        <input type="button" class="btn btn-primary "
                            style="margin-left: 10px;margin-right: 10px;" @click="getLog" value="Print Letter Report">
                        <input type="button" v-on:click="stockRecevingModalIs=false" class="btn btn-primary "
                            ...
                            style="margin-left: 10px;margin-right: 10px;" value="Delivery Details">
                        <input type="button"  class="btn btn-primary "
                               @click="printSupBill()" style="margin-left: 10px;margin-right: 10px;" value="Print Bill">
                        <input type="checkbox" name="" id="" style="margin-left: 10px;margin-right: 10px;margin-top:10px"><label for="" style="margin-right: 10px;" class="col-form-label">Letter Head?</label>
                        <input type="button"  class="btn btn-primary "
                            data-toggle="modal" data-target="#HoldModal"
                            style="margin-left: 10px;margin-right: 10px;" v-if="!isCompleted" value="Hold / Delayed">
                        <input type="button"  class="btn btn-primary "
                            data-toggle="modal" data-target="#cancelModal"
                            style="margin-left: 10px;margin-right: 10px;" v-if="!isCompleted" value="Cancal Job">
                    </div>
        ...
        <div class="modal fade bd-example-modal-2" id="HoldModal"   tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <letter-modal :jobid="this.id" :usertoken="this.usertoken"></letter-modal>
                            ...
                            <div class="col-md-12 col-sm-12" style="padding: 0px 30px 0px 30px;">
                                ...
                                <div class="">
                                    ...
                                    <a href="#"><button class="btn btn-success"><i
                                                class="fa fa-plus pr-2"></i>Add</button></a>
            ...
            <div class="row" style="padding: 5px 5px 9px 5px;">
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-2" v-if="!isHold">
                            <div class="form-check" style="margin-top: 4px;">
                        ...
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 pl-0 pr-0">
                                    <input  class="form-control  form-control-sm" v-model="billDate" type="date">
                        ...
                        <div class="col-md-8">
                            ...
                            <div id="section2">
                                ...
                                <input type="number" v-model="selectedBranch" id="branchId" :disabled="!selectedBank"  @input="getBranchById()"  class="form-control ">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">NTN/CNIC: </label>
                                        <div class="col-md-8 pl-0 pr-0">
                                            <input class="form-control  form-control-sm" v-model="bankCnic"
                                                 type="text">
                            ...
                            <div class="">
                                ...
                                <div v-show="iSanotherDest==true">
                                        ...
                                        <div class="form-group row" v-show="anIs=='3rd Party Godown'">
                                            <label for="" class="col-md-3 col-form-label">Location:</label>
                                            <div class="col-md-7">
                                                <Select class="mySelect" @input="getGodownDataForthreeAn" v-model="thanGodownLocation" :options="godowns" label="text">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" v-model="invoiceis" class="form-control">
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12" style="text-align:right;margin-top:10px">
                    ...
                    <a href="/supervision"><input type="button" class="btn btn-primary" value="Ignore"></a>
                    <a href="#"><input type="button" class="btn btn-primary" value="Progress"></a>
                </div>
...
<script>
    ...
    import Letter from './Report/Letter.vue';
    ...
    export default {
        ...
        methods: {
            getLog(){
                   window.open(
                            "/printSupervisionLogReport/"+this.id,
            ...
            getSupervisionJob() {
                axios.get('/getSupervisionJob/' + this.id)
                    .then(res => {
                        console.log(res.data);
                        res.data.job.forEach((obj) => {
                            this.invoiceis=obj.invoice_value_code;
                            ...
                            this.fromIs=obj.from_is;
                            this.fromTerminal = {
                                text: obj.terminal_name,
                                value: obj.fpt_terminal
                            };
                            this.fromWarehouse = {
                                text: obj.warehouse_name,
                                value: obj.fbw_warehouse
                            };
                            this.fromWarehouseAddress=obj.fbw_address;
                             this.fromGodownLocation = {
                                text: obj.godown_name,
                                value: obj.fpp_location
                            };
                            this.fromGodownNo=obj.fpp_godown_no;
                            this.isFromGodownBond=obj.fpp_bond==1?true:false;
                            this.fromGodownAddress=obj.fpp_address;

                            this.toIs=obj.to_is;
                             this.toWarehouse = {
                                text: obj.to_warehouse,
                                value: obj.tbw_warehouse
                            };
                            this.toWarehouseAddress=obj.tbw_address;
                             this.toGodownLocation = {
                                text: obj.to_godown,
                                value: obj.tpp_location
                            };
                            this.toGodownNo=obj.tpp_godwill;
                            this.toGodownAddress=obj.tpp_address;
                            this.istoGodownBond=obj.tpp_bond==1?true:false;
                            this.toGodownAddress=obj.tpp_addresss;

                             this.thGodownLocation = {
                                text: obj.three_godown,
                                value: obj.th_godown_location
                            };
                            this.thGodownNo=obj.th_godown_no;
                            this.isthGodownBond=obj.is_th_godown_bond==1?true:false;
                            this.thGodownAddress=obj.th_godown_address;

                          this.iSanotherDest=obj.is_another_destination==1?true:false;
                            this.anIs=obj.another_is;

                            this.anWarehouse = {
                                text: obj.anwarehouse_name,
                                value: obj.dbw_warehouse
                            };
                            this.anWarehouseAddress=obj.dbw_address;
                            this.anGodownLocation = {
                                text: obj.angodown_name,
                                value: obj.dpp_location
                            };
                            this.anGodownNo=obj.dpp_godown_no;
                            this.isanGodownBond=obj.dpp_bond==1?true:false;
                            this.anGodownAddress=obj.dpp_address;


                            this.thanGodownLocation = {
                                text: obj.angothree_name,
                                value: obj.dpg_location
                            };
                            this.thanGodownNo=obj.dpg_godown_no;
                            this.thanGodownAddress=obj.dpg_address;
                            this.isthanGodownBond=obj.dpg_bond==1?true:false;

                             this.clearingAgent = {
                                text: obj.agent_name,
                                value: obj.clearing_agent
                            };
                             this.consigment = {
                                text: obj.consigment_name,
                                value: obj.consignment
                            };
                             this.package = {
                                text: obj.packages_name,
                                value: obj.package_is
                            };
                             this.transporter = {
                                text: obj.transporter_name,
                                value: obj.rt_transporter
                            };
                             this.mucName = {
                                text: obj.muc_name,
                                value: obj.dtm_muccadum
                            };
                            this.packageCount=obj.package_unit;
                            this.packageWeight=obj.weight;
                            this.cont=obj.container_number;
                            this.contCount=obj.container_unit;
                            this.invoiceCount=obj.invoice_value;
                            this.importValue=obj.import_value_unit;
                            this.lcno=obj.lc_no;
                            this.lcdate=obj.lc_date;
                            this.vessel=obj.vessel_no;
                            this.vesseldate=obj.vessel_arrived;
                            this.blno=obj.bl_no;
                            this.bldate=obj.bl_date;
                            this.modeIs=obj.transportation_is;
                            this.receiptNo=obj.rr_receipt_no;
                            this.receiptDate=obj.rr_date;
                            this.delieveredTo=obj.delivered_to;
                            this.serviceChargeIs=obj.serv_chrg_is;
                            this.serviceRate=obj.service_rate;
                            this.serviceCharges=obj.service_charges;
                            this.isSalesTax=obj.is_sales_tax==1?true:false;
                            this.isReceieved=obj.is_received==1?true:false;
                            this.recievedFrom=obj.rec_from;
                            this.recievedVia=obj.rec_via;
                            this.recievedDate=obj.rec_via_date;
                            this.recievedNo=obj.rec_via_no;
                            this.remarks=obj.remarks;
                            this.billDate=obj.bill_date;
                            this.bankCnic=obj.bank_ntn;
        ...
        this.loading=true;
        axios.post('/printSupBill',billData,{responseType: 'arraybuffer'}).then(res=>{
        ...
        this.loading=false;
            ...
            onComplete: function() {
                ...
                axios.put('/updateSupervision/' + this.id, {
            ...
            cancelJob: function() {
                ...
                axios.put('/cancelSupervision/' + this.id, {
            ...
            holdJob: function() {
                ...
                axios.put('/holdSupervision/' + this.id, {
