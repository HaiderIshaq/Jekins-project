        ...
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">New LCR Job</h4>
                    </div>
                        ...
                        <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                            ...
                            <div class="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="radio" name="" id="" style="margin-left: -15px;"> <label for="" class="col-form-label">A</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="radio" name="" id="" style="margin-left: -35px;"> <label for="" class="col-form-label">B</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="radio" name="" id="" style="margin-left: -60px;"> <label for="" class="col-form-label">B-</label>
                                    </div>
                                    <div class="col-md-1">
                                        <input type="radio" name="" id="" style="margin-left: -80px;"> <label for="" class="col-form-label">C</label>
                                    </div>
                                    <div class="">
                                        <input type="radio" name="" id="" style="margin-left: -56px;"> <label for="" class="col-form-label">N/A</label>
                                    </div>
                                </div>
