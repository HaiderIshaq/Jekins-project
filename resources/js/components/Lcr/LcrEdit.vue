    ...
    <div class="bg-white border-radius-4 box-shadow mb-30" style="padding: 0px 15px 16px 15px">
      <div class="clearfix">
        <div class="row" style="background-color: #275129; padding-bottom: 15px">
          <div class="col-md-10">
            <h4 class="text-white pt-3">Edit LCR Job</h4>
          </div>
      ...
      <div class="row" style="padding: 5px 5px 9px 5px">
        <div class="col-md-12" style="text-align: left">
          <div class="row" style="float: left">
            <input
              type="button"
              v-on:click="letterModal = false"
              class="btn btn-primary"
              data-toggle="modal"
              data-target="#letterModal"
              style="margin-left: 10px; margin-right: 10px"
              value="Print Original Copy"
            />
            <input
              type="button"
              v-on:click="letterReportModalIs = false"
              class="btn btn-primary"
              data-toggle="modal"
              data-target="#letterReportModal"
              style="margin-left: 10px; margin-right: 10px"
              value="Print Duplicate Copy"
            />
            <input
              type="button"
              v-on:click="stockRecevingModalIs = false"
              class="btn btn-primary"
              data-toggle="modal"
              data-target="#stockRecevingModal"
              style="margin-left: 10px; margin-right: 10px"
              value="Print Office Copy"
            />
            <!-- <input
              type="button"
              v-on:click="stockInsuranceModalIs = false"
              class="btn btn-primary"
              data-toggle="modal"
              data-target="#stockInsuranceModal"
              style="margin-left: 10px; margin-right: 10px"
              value="Print Bill"
            />
            <input
              ...
              id=""
              style="margin-left: 10px; margin-right: 10px"
            /><label for="" class="col-form-label">Letter Head?</label> -->
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content container">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Print Original Copy</h5>
              ...
              <div class="col-md-12 col-sm-12" style="padding: 0px 30px 0px 30px">
                ...
                <div class="">
                  <div class="form-group row">
                    ...
                    <div class="col-md-3">
                      <input type="radio" name="" id="" />
                      <label for="" class="col-form-label">Clearing Agent</label>
                    </div>
                    <div class="col-md-3">
                      <input type="radio" name="" id="" />
                      <label for="" class="col-form-label">Bonded Warehouse</label>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-2">
                      <input type="radio" name="" id="" />
                      <label for="" class="col-form-label">First Letter</label>
                    </div>
                    <div class="col-md-2">
                      <input type="radio" name="" id="" />
                      <label for="" class="col-form-label">After Clearance</label>
                    </div>
                    <div class="col-md-2">
                      <input type="radio" name="" id="" />
                    ...
                    <div class="col-md-2">
                      <input type="radio" name="" id="" />
                      <label for="" class="col-form-label">Completion</label>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <textarea class="form-control" style="height: 50px" name="" id="" cols="42" rows="1"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="" class="col-md-3 col-form-label">Subject:</label>
                    <div class="col-md-9">
                      <textarea name="" id="" cols="42" rows="1" class="form-control" style="height: 50px"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row" style="padding-right: 30px">
                    <div class="col-md-12">
                      ...
                      <input type="button" @click="onComplete()" v-if="!saveButton" style="float: right; margin: 10px"
      ...
      <div class="modal fade" id="letterReportModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="letterReport">Print Duplicate Copy</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
      ...
      <div class="modal fade" id="stockRecevingModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
      ...
      <div class="modal fade" id="stockInsuranceModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
      ...
      <div class="modal fade" id="rateRevisionModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <a href="#"><button class="btn btn-success">
                  <i class="fa fa-plus pr-2"></i>New Revision
                </button></a>
      ...
      <div class="modal fade" id="stockReportModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="modal-dialog modal-xl" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row" style="padding-right: 30px">
                <div class="col-md-12">
                  <a href="/valuation"><input type="button" class="btn btn-primary" style="float: right; margin: 10px"
                      value="Cancel" /></a>
                  <input type="button" @click="onComplete()" v-if="!saveButton" style="float: right; margin: 10px"
                    class="btn btn-primary" value="Save" />
                </div>
          ...
          <div class="row">
            <div class="col-md-3" v-if="!isHold">
              <div class="form-check" style="margin-top: 4px">
                ...
                <label for="form-check-label" style="margin-right: 13px">
                  Completed?</label>
              </div>
            </div>
            <div class="col-md-6">
      ...
      <div class="tab-content" id="myTabContent">
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12" style="border-right: 1px solid #646161">
                  <div id="section1">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="custom-control custom-radio mb-5">
                              <input type="radio" v-model.trim="selected" id="customRadio1" name="type" value="Bank"
                          ...
                          <div class="col-md-4">
                            <div class="custom-control custom-radio mb-5">
                              <input type="radio" style="background-color: red !important" v-model.trim="selected"
                                id="customRadio2" name="type" value="Customers" class="custom-control-input" />
                              <label class="custom-control-label" for="customRadio2">Customer</label>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="custom-control custom-radio mb-5">
                              <input type="radio" v-model.trim="selected" id="customRadio3" name="type" value="Vendors"
                                class="custom-control-input" />
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8 pl-0 pr-0">
                        <Select id="company" label="text" :class="[{ invalid: $v.company.$error }, 'mySelect']"
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8 pl-0 pr-0">
                        <Select label="text" :class="[{ invalid: $v.region.$error }, 'mySelect']" v-model="region"
                          :options="regions"></Select>
                        <div v-if="$v.region.$error">
                          <p class="text-danger" v-if="!$v.region.required">
                            Select your region
                          </p>
                        </div>
                      </div>
                  ...
                  <div id="section2">
                    <fieldset id="section3" v-show="selected == 'Vendors'">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <textarea v-model="vendorAddress" cols="30" rows="2" class="form-control form-control-sm"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" v-model="vendorRepresent" :class="{
                              'date-invalid': $v.vendorRepresent.$error,
                            }" type="text" />
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Desig/Dept:
                        </label>
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" v-model="vendorDesignation" :class="{
                              'date-invalid': $v.vendorDesignation.$error,
                            }" type="text" />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input type="number" class="form-control form-control-sm" v-model="vendorPhone"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input type="email" class="form-control form-control-sm" v-model="vendorEmail"
                    ...
                    <fieldset id="section1" v-show="selected == 'Bank'">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-2">
                          <div class="form-check ml-4 islamic-check">
                            <input type="checkbox" class="form-check-input" @change="getBanksByIslam()"
                              v-model="btype" />
                        ...
                        <div class="col-md-1 pr-0">
                          <input type="button" value="Add" class="btn btn-primary" data-toggle="modal"
                            data-target="#bankModal" style="font-size: 12px" />
                        </div>
                      </div>
                      <div class="modal fade bd-example-modal-2" id="bankModal" tabindex="-1" role="dialog"
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form enctype="multipart/form-data">
                                <div class="form-group row">
                                  <div class="col-md-12">
                                    ...
                                    <div v-if="$v.bankName1.$error">
                                      <p class="text-danger" v-if="!$v.bankName1.required">
                                ...
                                <div class="form-group row">
                                  <div class="col-md-12">
                                    ...
                                    <div v-if="$v.bankCode1.$error">
                                      <p class="text-danger" v-if="!$v.bankCode1.required">
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div v-if="$v.bankIbr.$error">
                                        <p class="text-danger" v-if="!$v.bankIbr.required">
                                ...
                                <button type="button" @click="addBank()" class="btn btn-primary">
                                  Add Bank
                                </button>
                              </form>
                            </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-2" style="padding-left: 15px !important">
                          <input type="button" value="Add" class="btn btn-primary branch-btn" :disabled="!selectedBank"
                          ...
                          <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form enctype="multipart/form-data">
                                  <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Branch Name / Branch
                                      Address:</label>
                                    <input type="text" v-model="branchName" class="form-control" :class="{
                                        'date-invalid': $v.branchName.$error,
                                      }" />
                                    <div v-if="$v.branchName.$error">
                                      <p class="text-danger" v-if="!$v.branchName.required">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <Select v-model="branchCity" label="text" :options="cities" :class="[
                                        {
                                    ...
                                    <div v-if="$v.branchCity.$error">
                                      <p class="text-danger" v-if="!$v.branchCity.required">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" v-model="branchAddress" class="form-control" :class="{
                                        'date-invalid': $v.branchAddress.$error,
                                      }" />
                                    <div v-if="$v.branchAddress.$error">
                                      <p class="text-danger" v-if="!$v.branchAddress.required">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" v-model="branchLandline" class="form-control" :class="{
                                        'date-invalid':
                                          $v.branchLandline.$error,
                                      }" />
                                    <div v-if="$v.branchLandline.$error">
                                      <p class="text-danger" v-if="!$v.branchLandline.required">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Phone:</label>
                                        <input type="number" v-model="branchPhone" class="form-control" :class="{
                                            'date-invalid':
                                              $v.branchPhone.$error,
                                          }" />
                                        <div v-if="$v.branchPhone.$error">
                                          <p class="text-danger" v-if="!$v.branchPhone.required">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <input type="number" v-model="branchCode" class="form-control" :class="{
                                            'date-invalid':
                                              $v.branchCode.$error,
                                          }" />
                                        <div v-if="$v.branchCode.$error">
                                          <p class="text-danger" v-if="!$v.branchCode.required">
                                  ...
                                  <button type="button" @click="addBranch()" class="btn btn-primary">
                                    Add Branch
                                  </button>
                                </form>
                              </div>
                      ...
                      <div class="form-group row">
                        <label for="" class="col-md-3 col-form-label">Billing Address</label>
                        <div class="col-md-8 pl-0 pr-0">
                          <textarea type="text" name="" v-model="billingAddress" :class="{
                              'date-invalid': $v.billingAddress.$error,
                            }" cols="30" rows="2" class="form-control form-control-sm" style="height: 60px"></textarea>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" v-model="bankRepresentative" :class="{
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" v-model="bankDesignation" :class="{
                              'date-invalid': $v.bankDesignation.$error,
                            }" type="text" />
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label">Phone: </label>
                        <div class="col-md-8 pl-0 pr-0">
                          <input type="number" v-model="bankPhone" :class="{ 'date-invalid': $v.bankPhone.$error }"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-3 pl-0">
                          <input type="text" v-model="bankletterNo" class="form-control form-control-sm"
                        ...
                        <div class="col-md-3 pl-0">
                          <input class="form-control form-control-sm" v-model="bankDate"
                            :class="{ 'date-invalid': $v.bankDate.$error }" style="margin-left: 18px; min-width: 152px"
                            name="txtDate2" type="date" />
                          <div v-if="$v.bankDate.$error">
                            <p class="text-danger" style="margin-left: 20px" v-if="!$v.bankDate.required">
                    ...
                    <fieldset id="section2" v-show="selected == 'Customers' || 'Vendors' || 'Bank'">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-2" style="padding-left: 0px !important">
                          <input type="button" class="btn btn-primary branch-btn" data-toggle="modal"
                            data-target="#customerModal" style="margin-left: 16px; font-size: 12px" value="Add" />
                        </div>
                      </div>
                      <div class="modal fade bd-example-modal-2" tabindex="-1" role="dialog" id="customerModal"
                        aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                              <form enctype="multipart/form-data">
                                <div class="form-group row">
                                  <div class="col-md-6">
                                    ...
                                    <div v-if="$v.customerName1.$error">
                                      <p class="text-danger" v-if="!$v.customerName1.required">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div v-if="$v.customerCode1.$error">
                                      <p class="text-danger" v-if="!$v.customerCode1.required">
                                ...
                                <div class="form-group">
                                  ...
                                  <Select :options="cities" label="text" v-model="customerCity" :class="{
                                ...
                                <div class="form-group">
                                  <label for="recipient-name" class="col-form-label">Address:</label>
                                  <input v-model="customerAddress1" class="form-control" :class="{
                                      'date-invalid':
                                        $v.customerAddress1.$error,
                                    }" />
                                  <div v-if="$v.customerAddress1.$error">
                                    <p class="text-danger" v-if="!$v.customerAddress1.required">
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="recipient-name" class="col-form-label">Phone:</label>
                                      <input type="number" v-model="customerPhone1" class="form-control" :class="{
                                          'date-invalid':
                                            $v.customerPhone1.$error,
                                        }" />
                                      <div v-if="$v.customerPhone1.$error">
                                        <p class="text-danger" v-if="!$v.customerPhone1.required">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" v-model="customerFax1" :class="{
                                          'date-invalid':
                                            $v.customerFax1.$error,
                                        }" class="form-control" />
                                      <div v-if="$v.customerFax1.$error">
                                        <p class="text-danger" v-if="!$v.customerFax1.required">
                                ...
                                <div class="form-group row">
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="customerCNIC" class="form-control" :class="{
                                        'date-invalid': $v.customerCNIC.$error,
                                      }" />
                                    <div v-if="$v.customerCNIC.$error">
                                      <p class="text-danger" v-if="!$v.customerCNIC.required">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div v-if="$v.customerGst.$error">
                                      <p class="text-danger" v-if="!$v.customerGst.required">
                                        Please input tax no
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="customerPerson" :class="{
                                        'date-invalid':
                                          $v.customerPerson.$error,
                                      }" class="form-control" />
                                    <div v-if="$v.customerPerson.$error">
                                      <p class="text-danger" v-if="!$v.customerPerson.required">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" v-model="customerDesignation1" :class="{
                                        'date-invalid':
                                          $v.customerDesignation1.$error,
                                      }" class="form-control" />
                                    <div v-if="$v.customerDesignation1.$error">
                                      <p class="text-danger" v-if="!$v.customerDesignation1.required">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" :class="{
                              'date-invalid': $v.customerRepresent.$error,
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <textarea style="height: 50px" class="form-control form-control-sm" v-model="customerLocation"
                            type="text">
                          </textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" type="number"
                            :class="{ 'date-invalid': $v.customerPhone.$error }" v-model="customerPhone" />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input class="form-control form-control-sm" type="email"
                            :class="{ 'date-invalid': $v.customerEmail.$error }" v-model="customerEmail" />
                ...
                <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                  ...
                  <div class="">
                    ...
                    <h5 style="padding-bottom:5px">Target Company's Details</h5>
                    <br>
                    ...
                    <div class="form-group row">
                      ...
                      <!-- <div class="col-md-4">
                            <input type="radio" name="" id=""> <label for="" class="form-label">Public Limited</label>
                        </div> -->
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Address:</label>
                      <div class="col-md-9">
                        <textarea class="form-control" style="height: 50px;" name="" id="" cols="42"
                          rows="1"></textarea>
                      </div>
                    </div>

                    <!-- <div class="form-group row">
                        <label for="" class="col-md-3 col-form-label">Service Charges:</label>
                        <div class="col-md-5">
                            <select class="form-control" name="location" id="location">
                                <option value="abc">abc</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="" id=""> <label class="form-label" for="">Sales Tax?</label>
                        </div>
                    </div> -->

                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Street:</label>
                      <div class="col-md-3">
                        <input type="text" name="" class="form-control" id="">
                      </div>
                      <label for="" class="col-md-3 col-form-label">P.O. Box:</label>
                      <div class="col-md-3">
                        <input type="text" name="" class="form-control" id="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Registration ID:</label>
                      <div class="col-md-9">
                        <input type="text" name="" class="form-control" id="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Addtional Information:</label>
                      <div class="col-md-9">
                        <textarea class="form-control" style="height: 50px;" name="" id="" cols="42"
                          rows="1"></textarea>
                      </div>
                    ...
                    <h5 style="padding-bottom:5px">Report Details</h5>
                    <br>

                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Delivery Time:</label>
                      <div class="col-md-9">
                        <select name="" class="form-control" id="">
                          <option value="">abc</option>
                        </select>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">E.D.D.:</label>
                      <div class="col-md-3">
                        <input type="date" name="" class="form-control" id="">
                      </div>
                      <label for="" class="col-md-3 col-form-label">Service Charges:</label>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Inspected On:</label>
                      <div class="col-md-3">
                        <input type="date" name="" class="form-control" id="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Rating:</label>
                      <div class="col-md-2">
                        <input type="radio" name="" id=""> <label for="" class="col-form-label">AA</label>
                      </div>
                      <div class="col-md-2">
                        <input type="radio" name="" id="" style="margin-left: -15px;"> <label for=""
                          class="col-form-label">A</label>
                      </div>
                      <div class="col-md-2">
                        <input type="radio" name="" id="" style="margin-left: -35px;"> <label for=""
                          class="col-form-label">B</label>
                      </div>
                      <div class="col-md-2">
                        <input type="radio" name="" id="" style="margin-left: -60px;"> <label for=""
                          class="col-form-label">B-</label>
                      </div>
                      <div class="col-md-1">
                        <input type="radio" name="" id="" style="margin-left: -80px;"> <label for=""
                          class="col-form-label">C</label>
                      </div>
                      <div class="">
                        <input type="radio" name="" id="" style="margin-left: -56px;"> <label for=""
                          class="col-form-label">N/A</label>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Credit Option:</label>
                      <div class="col-md-9">
                        <textarea class="form-control" style="height: 50px;" name="" id="" cols="42"
                          rows="1"></textarea>
                      </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Credit Limit:</label>
                      <div class="col-md-9">
                        <input type="text" name="" class="form-control" id="">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label for="" class="col-md-3 col-form-label">Revision:</label>
                      <div class="col-md-9">
                        <input type="text" name="" class="form-control" id="">
                      </div>
                    </div>
        ...
        <div class="tab-pane fade" id="stock" role="tabpanel" aria-labelledby="stock-tab">
          <div style="border: 2px solid #275129; margin: 0px; padding: 33px" class="wizard-content pt-4">
            <a href="#"><button class="btn btn-success">
                <i class="fa fa-plus pr-2"></i>New Item
              </button></a>
            <br />
        ...
        <div class="tab-pane fade" id="godown" role="tabpanel" aria-labelledby="godown-tab">
          <div style="border: 2px solid #275129; margin: 0px; padding: 33px" class="wizard-content pt-4">
            <a href="#"><button class="btn btn-success">
                <i class="fa fa-plus pr-2"></i>Hire Godown Keeper
              </button></a>
            <a href="#"><button class="btn btn-success">
                <i class="fa fa-plus pr-2"></i>Re-Hire Godown Keeper
              </button></a>
            <a href="#"><button class="btn btn-success">
                <i class="fa fa-plus pr-2"></i>Attach Hired Godown Keeper
              </button></a>
            <br />
            <table class="table display" id="myTable1">
              <thead class="thead-dark">
...
<script>
    ...
    export default {
        ...
        methods: {
            getInspectionJob() {
                axios.get("/getInspectionJob/" + this.id).then((res) => {
                    ...
                    res.data.job.forEach((obj) => {
                        ...
                        this.declaredCurrencyPrint =
                            obj.declared_currency_print === 1 ? true : false;
                        this.declaredCurrencyAttachments =
                            obj.declared_currency_attachments === 1 ? true : false;
                        this.declaredAsPer = obj.declared_as_per;
                        this.declaredNoLabelInput = obj.declared_no_label_input;
                        this.declaredNoLabelAttachments =
                            obj.declared_no_label_attachments === 1 ? true : false;
                        this.declaredRemarksPrint =
                            obj.declared_remarks_print === 1 ? true : false;
                        ...
                        this.insuranceWithBank =
                            obj.is_insurance_with_bank === 1 ? true : false;
                        ...
                        this.inspectionNextLine =
                            obj.inspection_next_line === 1 ? true : false;
