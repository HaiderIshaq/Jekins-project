<template>
     <div class="container-fluid bg-white box-shadow  pt-4 pb-4" id="app">
        ...
        <b>Receipt Id: </b>{{recId}}<br>
        <!-- <b>Amuonts: </b>{{amounts}} <br> -->
      <div class="hide"><b>Jobs Selected: </b>{{jobs}} <br></div>
     <div class="hide"><b>Jobs Removed: </b> {{removedBills}}</div>
        <div class="row mt-3">
                <div class="col-md-6">
                    <div id="section1 ">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-5">
                                <div class="form-check">
                                    <input type="checkbox"  class="form-check-input input-sm"  id="advance"  name="type" value="Yes">
                        ...
                        <div class="form-group row">
                            ...
                            <!-- <div class="col-md-4">
                                    <button class="btn btn-primary btn-sm mt-1"  type="button" @click="filterResult"  >Show Bills</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 pl-0 pr-0">
                                <input class="form-control input-sm" :class="{'date-invalid':$v.instrumentNumber.$error}" v-model="instrumentNumber" type="text">
                            ...
                            <div class="col-md-4  pr-0">
                               <datepicker :input-class="[{'date-invalid':$v.instrumentDate.$error},'form-control input-sm']"  valueType="format" format="d/M/yy" v-model="instrumentDate" ></datepicker>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-4  pr-0">
                               <datepicker :input-class="[{'date-invalid':$v.depositOn.$error},'form-control input-sm']"  valueType="format" :format="'d/M/yy'" v-model="depositOn" ></datepicker>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0 pr-0">
                                    <input class="form-control input-sm"  :class="{'date-invalid':$v.slipNo.$error}" v-model="slipNo"  type="text"   >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 pl-0">
                                <input class="form-control input-sm" :class="{'date-invalid':$v.gross.$error}" v-model="gross" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"   name="txtDate" type="number" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0">
                                <div class="row">
                                    ...
                                    <input class="form-control input-sm col-md-2" v-model="itamount" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"   type="number"   >
                                    <label class="col-md-1" >%: </label>
                                    <input class="form-control input-sm col-md-2" v-model="itper"  type="number" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"   >
                                    <label class="col-md-2">Amount: </label>
                                    <input class="form-control input-sm col-md-3 " readonly v-model="itax"  type="number" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0">
                                <div class="row">
                                    <label class="col-md-2" >Value: </label>
                                    <input class="form-control input-sm col-md-2"  v-model="stamount" type="number"   onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                                    <label class="col-md-1" >%: </label>
                                    <input class="form-control input-sm col-md-2" v-model="stper"   type="number"   onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                                    <label class="col-md-2">Amount: </label>
                                    <input class="form-control input-sm col-md-3 " readonly  v-model="stax"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 pl-0">
                                <input class="form-control input-sm" v-model="bcharges"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                            </div>
                            <label class="col-md-2 mt-1 ">Excessive Amount: </label>

                            <div class="col-md-3  pr-0">
                                    <input class="form-control input-sm" v-model="extra" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 pl-0">
                                <input class="form-control input-sm"  v-model="net" :class="{'date-invalid':$v.net.$error}">
                            ...
                            <div class="col-md-3  pr-0">
                                <input class="form-control input-sm"  v-model="bill" readonly  type="number" :class="{'date-invalid':$v.bill.$error}">
                        ...
                        <div class="form-group row pb-3" v-show="insscan" >
                            ...
                            <div class="col-md-2 pl-0 pr-0" >
                                <input type="file" style="padding-left: 4px;padding-top: 6px;" class="form-control  form-control-sm" ref="instrumentScan" @change="getInstrumentFile" :class="{ 'date-invalid': $v.instrumentScan.$error }">
                                <div v-if="$v.instrumentScan.$error">
                                        <p class=" text-danger" v-if="!$v.instrumentScan.required">This file is required</p>
                                    </div>
                            </div>
                            <div class="col-md-3">
                            <div class="row" style="padding: 4px 10px;font-size:13px" v-if="this.instrumentScanis==''">
                               <b>no file selected</b>

                            </div>

                            <div class="row" style="padding: 4px 10px;font-size:13px" v-else>
                                    <p><b>1 file selected</b></p>
                        ...
                        <div class="modal fade" id="instrumentScanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                            <div class="modal-content">

                            <div class="modal-body">
                                <a :href="instrumentScanis" target="_blank">
                        ...
                        <div class="form-group row pb-3"  v-show="depscan">
                            ...
                            <div class="col-md-2 pl-0 pr-0" >
                                <input type="file" style="padding-left: 4px;padding-top: 6px;" class="form-control  form-control-sm" ref="slipScan"  @change="getSlipScan" :class="{ 'date-invalid': $v.slipScan.$error }"  >
                            ...
                            <div class="col-md-3">
                                <div class="row" style="padding: 4px 10px;font-size:13px" v-if="this.depSlipScanis==''" >
                                   <b>no file selected</b>
                        ...
                        <div class="modal fade" id="depScanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                            <div class="modal-content">

                            <div class="modal-body">
                                <a :href="depSlipScanis" target="_blank">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0 pr-0">
                                <textarea class="form-control input-sm" name="" id="" :class="{'date-invalid':$v.remarks.$error}" v-model="remarks"  cols="30"  style="height:60px"></textarea>
                        ...
                        <table id="myTable" class="table table-wrapper-scroll-y my-custom-scrollbar">
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-for='(bill,b) in bills' :key="b" :title="'Total Bill: '+ Number(bill.total_amount)">
                                                ...
                                                <td  >
                                                    <input readonly style="width:140px !important"  type="number" v-bind:id="'totalBill'+bill.id" class="form-control form-control-sm" @input="showActionFields(bill.id)" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))"  :value="bill.service_charges"   >
                                                        <div class="row">
                                                            <div class="col-md-12" style="padding: 10px 16px 6px 16px;text-align:left">
                                                                ...
                                                                <input v-bind:id="'oldBill'+bill.id" readonly type="hidden"  :value="bill.service_charges">
                                                            </div>
                                                        </div>
                                                        </td>
                                                    <td >
                                                    <input readonly style="width:120px !important" type="number" v-bind:id="'totalOthers'+bill.id" class="form-control form-control-sm" @input="showActionFields(bill.id)" :value="bill.other_charges"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                                                    <input  v-bind:id="'oldOthers'+bill.id"  type="hidden"  :value="bill.other_charges">


                                                    </td>
                                                    <td>
                                                    <input readonly style="width:120px !important" type="number" v-bind:id="'myTax'+bill.id" class="form-control form-control-sm" @input="showActionFields(bill.id)" :value="bill.tax"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" >
                                                    <input  v-bind:id="'oldTax'+bill.id"  type="hidden"  :value="bill.tax">
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Editing Bill</h5>

                                                        <a :href="myroute"><button type="button"  class="btn btn-success"  aria-label="View Job">
                                                        <span  aria-hidden="true">View Job</span>
                                                        </button></a>
                                                    </div>
                                                <div class="modal-body">
                                                    <label for=""> Bill Number</label>
                                                    <input type="text" v-model="billId" readonly class="form-control">

                                                    <input type="hidden" v-model="bid" readonly class="form-control ">
                                                    <input type="text" v-model="bindex" readonly class="form-control ">
                                                    <input type="hidden" v-model="prevBill" readonly class="form-control ">

                                                        <br>
                                                    <label for=""> Date</label>
                                                    <input type="text" readonly v-model="billDate" class="form-control">
                                                    <br>
                                                    <label for=""> Branch</label>
                                                    <input type="text" readonly v-model="billBranch" class="form-control">
                                                        <br>
                                                    <label for=""> Customer</label>
                                                    <input type="text" readonly v-model="billCustomer" class="form-control">
                                                        <br>
                                                    <label for=""> Amount</label>
                                                    <input type="number" v-model="billamount"  class="form-control">
                                                        <br>
                                                    <label for=""> Sales Tax</label>
                                                    <input type="number" v-model="billSales" class="form-control">
                                     ...
                                     <br>
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:right" v-show="status==false">
                                            <button v-if="!saveButton" class="btn btn-primary input-sm ml-2" @click="saveReceipt()" id="save">Post</button>
                                            <a href="/posts"><button class="btn btn-primary input-sm" style="margin-right: -6px;"  >Cancel</button></a>
                                            <!-- @click="cancelBills()" -->
                                            <button  class="btn btn-primary input-sm ml-1" @click="rejectReceipt()" id="save">Delete Receipt</button>
                                        </div>
                    ...
                    <div class="tab-pane fade show " style="display:none" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <table class="table table-wrapper-scroll-y my-custom-scrollbar">
                                    ...
                                    <div class="row">
                                        ...
                                        <button class="btn btn-primary input-sm ml-2" @click="postReceipt()" id="save">Post</button>
                                        </div>
      ...
      updateBtn(id,bill,b,tax,bid){
            ...
            if(total < 1)
            {
             ...
             var x = document.getElementById("updateBtn"+id);
                ...
                {
                    // this.selectedTax[b]=Number(tax);

                            // alert(this.amounts);;
                    // this.$set(this.amounts, total, 2200);

                    // alert('Needs to be updated' + this.amounts );
                    removeA(this.amounts, bill);
                    removeA(this.selectedTax, tax);
                    this.amounts.push(Number(total));
            ...
            this.bills[b].total_amount=Number(total);
            ...
            console.log(reportData);
             ...
             axios.post('/updateBill/' + id,reportData).then(res=>{
...
//
   ...
   getBanks(){
        ...
        .then(res=>{
            res.data.forEach((obj)=>{
                let text='';
                let value='';
                this.banks.push({text:obj.bank_name,value:obj.bank_id})
            })
        })
    },
   getRegion(){
     ...
     showModal(id,number,date,branch,customer,total,tax,b){
         this.bid=id;
         this.billId=number;
         this.bindex=b;
         this.billDate=date;
 ...
 postData(){
        ...
        //     }
                    ...
                    reportData.append("rid", this.jobid);
                    reportData.append("receiptID", this.recId);
                    ...
                    axios.post('/ApproveReceipt',reportData).then(res=>{
        ...
        postReceipt(){
             ...
             let reportData={
                bills:this.ids,
                removed:this.removedBills,
                rid:this.jobid,
                recId:this.recId,
                gross_amount:this.gross,
                st_value:this.stamount,
                sales_tax_amount:this.stax,
                bank_charges:this.bcharges,
                income_tax_amount:this.itax,
                it_per_is:this.itper,
                st_per:this.stper,
                extra_charges:this.extra
            };
                 console.log(reportData);
            ...
            //  this.selectedReceipts=[];
             alert('Receipt ['+ this.recId +'] posted');
                this.updateStats();
       ...
       updateBill(){
            ...
            console.log(reportData);
            // var bill=this.bindex;
            // const currentIndex = this.bills[bill];
            // var updatedID =3;
            // this.bills.splice(currentIndex, 1, updatedID);

            // alert(currentIndex);
             axios.post('/updateBill/' + this.bid,reportData).then(res=>{
             alert('Bill Updated Successfully');
             $('#exampleModal').modal('hide');
             this.getBillsById(this.ids.join());
            //  this.getReceipts();
   ...
   getRegion(){
        ...
        getBills(){
            ...
            console.log(reportData);
               axios.post('/getBills',reportData)
                    .then(res=>{
        ...
        getBillsById(ids){
            ...
            console.log(reportData);
            //    axios.post('/getBillsForEdit',reportData)
               axios.post('/getBillsForEditPrism',reportData)
                    .then(res=>{
                        // console.log(res.data);
                        // alert(res.data);
                        res.data.forEach((obj)=>{

                            this.chbill.push(obj.id);
                            this.jobs.push(obj.job_number);
                            this.amounts.push(obj.total_amount);
                            this.selectedTax.push(obj.tax);
        ...
        getReceiptsByID(){
        // this.reciepts=[];
            axios.get('/getReceiptsById/' + this.jobid)
                .then(res=>{
                        res.data.forEach((obj)=>{

                        this.recId=obj.receipt_id;
                        this.getBillsById(obj.bills_id);
                        this.recievedOn=obj.recieved_on;
                        this.instrument={text:obj.method,value:obj.instrument_type};
                        this.account={text:obj.bank_account,value:obj.deposit_bank};

                        if(obj.client_copy == '' || obj.client_copy == null || obj.client_copy == "Documents/Livestock/" )
                        {
                          this.instrumentScanis='';


                        }
                        else{
                          this.instrumentScanis=window.location.origin+'/'+obj.client_copy;


                        }
                        if(obj.deposit_copy == '' || obj.deposit_copy == null || obj.deposit_copy == "Documents/Livestock/" )
                        {
                          this.depSlipScanis='';
                            ...
                            this.depSlipScanis=window.location.origin+'/'+obj.deposit_copy;


                        }
                        this.instrumentNumber=obj.instrument_number;
                        this.instrumentDate=obj.instrument_date;
                        this.depositOn=obj.deposit_date;
                        this.slipNo=obj.slip_number;
                        this.gross=obj.gross;
                        this.bcharges=obj.bank_charges;
                        this.extra=obj.extra_charges;
                        this.bill=obj.amount;
                        this.remarks=obj.remarks;

                        this.itamount=obj.IT_value;
                        this.itper=obj.it_per;
                        this.stamount=obj.ST_value;
                        this.stper=obj.st_per;
                        //    this.itax=obj.income_tax_amount;
        ...
        getReceipts(){
         ...
         getAmount(key){
            ...
            removeA(this.removedBills, this.bills[key].id);
            // this.amounts.push(Number(this.bills[key].total_amount));
            this.amounts.push(Number(this.bills[key].service_charges)+Number(this.bills[key].other_charges)+Number(this.bills[key].tax));
            ...
            this.removedBills.push(this.bills[key].id);
            // removeA(this.amounts, Number(this.bills[key].total_amount));
            removeA(this.amounts, Number(this.bills[key].service_charges)+Number(this.bills[key].other_charges)+Number(this.bills[key].tax));
      ...
      if(this.allSelected){ // Check all
        ...
        //   this.removedBills.push(this.bills[key].job_number);
          this.selectedTax.push(Number(this.bills[key].tax));
            this.removedBills=[];
