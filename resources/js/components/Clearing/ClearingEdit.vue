<template>
  <div class="container-fluid">
    <div
      class="bg-white border-radius-4 box-shadow mb-30"
      style="padding: 0px 15px 16px 15px"
    >
      <div class="clearfix">
        <div
          class="row"
          style="background-color: #275129; padding-bottom: 15px"
        >
          <div class="col-md-10">
            <h4 class="text-white pt-3">Edit Clearing Job</h4>
          </div>
      ...
      <div class="tab-content" id="myTabContent">
        ...
        >
          <form action="">
            <div
              style="border: 2px solid #275129; margin: 0px; padding: 33px"
              class="wizard-content pt-4"
            >
              <div class="row">
                <div
                  class="col-md-6 col-sm-12"
                  style="border-right: 1px solid #646161"
                >
                  <div id="section1">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8 pl-0 pr-0">
                        <Select
                          label="text"
                          :class="[{ invalid: $v.region.$error }, 'mySelect']"
                          v-model="region"
                          :options="regions"
                        ></Select>
                  ...
                  <div id="section2">
                    <fieldset id="section3" v-show="selected == 'Vendors'">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <textarea
                            ...
                            rows="2"
                            class="form-control form-control-sm"
                            :class="{ 'date-invalid': $v.vendorAddress.$error }"
                          ></textarea>
                          <div v-if="$v.vendorAddress.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.vendorAddress.required"
                            >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.vendorRepresent.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.vendorRepresent.required"
                            >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.vendorDesignation.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.vendorDesignation.required"
                            >
                              Please input vendor representative
                            </p>
                          </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-3">
                          <input
                            class="form-control form-control-sm"
                            v-model="vendorExpiry"
                            :class="{ 'date-invalid': $v.vendorExpiry.$error }"
                            style="margin-left: 18px; min-width: 152px"
                            name="txtDate1"
                            type="date"
                          />
                          <div
                            v-if="$v.vendorExpiry.$error"
                            style="margin-left: 20px"
                          >
                            <p
                              class="text-danger"
                              v-if="!$v.vendorExpiry.required"
                            >
                    ...
                    <fieldset id="section1" v-show="selected == 'Bank'">
                      ...
                      <div
                        class="modal fade bd-example-modal-2"
                        id="bankModal"
                        tabindex="-1"
                        role="dialog"
                        aria-labelledby="myLargeModalLabel"
                      ...
                      <div class="form-group row">
                        ...
                        >
                          <input
                            type="button"
                            value="Add"
                            class="btn btn-primary branch-btn"
                            :disabled="!selectedBank"
                            data-toggle="modal"
                                ...
                                <form enctype="multipart/form-data">
                                  <div class="form-group">
                                    <label
                                      for="recipient-name"
                                      class="col-form-label"
                                      >Branch Name / Branch Address:</label
                                    >
                                    <input
                                      type="text"
                                      v-model="branchName"
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.bankRepresentative.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.bankRepresentative.required"
                            >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.bankDesignation.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.bankDesignation.required"
                            >
                    ...
                    <fieldset
                      id="section2"
                      v-show="selected == 'Customers' || 'Vendors' || 'Bank'"
                    >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.customerRepresent.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.customerRepresent.required"
                            >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          <input
                            ...
                            v-model="customerDesignation"
                            type="text"
                          />
                          <div v-if="$v.customerDesignation.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.customerDesignation.required"
                            >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-8 pl-0 pr-0">
                          ...
                          <div v-if="$v.customerEmail.$error">
                            <p
                              class="text-danger"
                              v-if="!$v.customerEmail.required"
                            >
                              Please input customer email address
                            </p>
                            <p
                              class="text-danger"
                              v-if="!$v.customerEmail.email"
                            >
                ...
                <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                    ...
                    <div class="">
                        ...
                        <div class="form-group row">
                            <lable for="" class="col-md-3 col-form-label">Containers</lable>
                            <div class="col-md-3">
                                <input type="text" name="" class="form-control" id="">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">Duty </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">

                            </div>
                            <label class="col-md-2 form-label">Sales Tax: </label>
                            <div class="col-md-3 pl-0">
                                <input class="form-control form-control-sm" name="" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">Add. Sales Tax: </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">Other Taxes: </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="" class="col-md-3 col-form-label">Shipped From:</label>
                            <div class="col-md-9">
                                <select class="form-control" name="location" id="location">
                                    <option value="abc">abc</option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">IGM/VIR No.: </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">Index No.: </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 form-label">GD No.: </label>
                            <div class="col-md-4 pl-3">
                                <input class="form-control form-control-sm" name="" type="text">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-label">Terminal: </label>
                            <div class="col-md-9">
                        ...
                        <hr>
                                <div class="form-group row">
                                    <div class="col-md-5">
                                        <input type="radio" name="" id=""> <label for="">Bonded  Warehouse</label>
                                    </div>  
                                    <div class="col-md-4" style="margin-left: -30px;">
                                        <input type="radio" name="" id=""> <label for="">Party Premises</label>
                                    </div>
                                    
                                    <div>
                                        <input type="radio" name="" id=""> <label for="">3rd Party Premises</label>
                                    </div>
                                </div>
                        <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <input type="radio" name="" id=""> <label for="">Rail Road</label>
                        </div>
                         <div class="col-md-6">
                            <input type="radio" name="" id=""> <label for="">Raod Transport</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Bank </label>
                        </div>
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Borrower </label>
                        </div>
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Muccadum </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Per Container </label>
                        </div>
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Break Bulk </label>
                        </div>
                        <div class="col-md-4">
                           <input type="radio" name="" id=""> <label class="form-label">Lumpsum </label>
                        </div>
                    </div>
      ...
      <div class="row">
        <div class="col-md-12" style="text-align: right; margin-top: 10px">
          ...
          />
          <a href="/inspection"
            ><input type="button" class="btn btn-primary" value="Ignore"
          /></a>
          <a href="#"
            ><input type="button" class="btn btn-primary" value="Comments"
          /></a>
          <a href="#"
            ><input
              type="button"
