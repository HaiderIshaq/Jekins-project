...
<!-- :disabled-dates="disabledDates" -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                    <button class="btn btn-primary btn-sm "  type="button" @click="filterResult"  >Show Bills</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0">
                                <div class="row">
                                    ...
                                    <input tabindex="5" class="form-control input-sm col-md-2 " readonly v-model="itax"  type="number" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 pl-0">
                                <div class="row">
                                    ...
                                    <label class="col-md-3">Amount: </label>
                                    <input class="form-control input-sm col-md-2 " tabindex="8" readonly  v-model="stax"  onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))">
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="myTable" class="table table-wrapper-scroll-y my-custom-scrollbar">
                                        ...
                                        <tbody>
                                            ...
                                            <tr v-for='(bill,b) in bills' :key="b" :title="'Total Bill: '+ Number(bill.total_amount)">
                                                ...
                                                <td  >
                                                    <input style="width:140px !important"  type="number" @input="showActionFields(bill.id)" v-bind:id="'totalBill'+bill.id" class="form-control form-control-sm"   :value="bill.total_amount"   >
                                                        <div class="row">
                                                            <div class="col-md-12" style="padding: 10px 16px 6px 16px;text-align:left">
                                                                ...
                                                                <input v-bind:id="'oldBill'+bill.id" readonly type="hidden"  :value="bill.total_amount">
                                                            </div>
                                                        </div>
                                                        </td>
                                                    <td >
                                                        <input style="width:120px !important" type="number"   v-bind:id="'myTax'+bill.id" @input="showActionFields(bill.id)" class="form-control form-control-sm" :value="bill.tax"  >
