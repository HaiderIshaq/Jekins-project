        ...
        <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
            ...
            <div class="clearfix">
                <div class="row" style="background-color:#275129;padding-bottom:15px">
                    <div class="col-md-10">
                        <h4 class="text-white  pt-3">New Income Estimate Job</h4>
                    </div>
                    <div class="col-md-2" style="text-align: right;">
                        <a href="/ie" style="margin-top: 12px;margin-left: 50px;
                      color: black;
                        ...
                        <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                            ...
                            <div class="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <Select v-model="operationalBranch" :options="regions" label="text"></Select>
                                    </div>
                                </div>
                                 
                                 <hr>
                                <h5 style="padding-bottom:5px">Target Company Details</h5>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-2 form-label">P.O Box: </label>
                                    <div class="col-md-3 pl-0">
                                        <input class="form-control form-control-sm" name="" type="text">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-2 form-label">Fax: </label>
                                    <div class="col-md-3 pl-0">
                                        <input class="form-control form-control-sm" name="" type="text">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                     <label for="" class="col-md-3 col-form-label">Addtional Informations:</label>
                                    <div class="col-md-9">
                                        <input type="text" name="" class="form-control" id="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 form-label">Delivery Time: </label>
                                    <div class="col-md-4 pl-3">
                                       <select class="form-control">
                                           <option>abc</option>
                                       </select>
                                    </div>
                                    <label class="col-md-2 form-label">E.D.D.: </label>
                                    <div class="col-md-3 pl-0">
                                  ...
                                  <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Contacted:</label>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Decision:</label>
                                    <div class="col-md-4">
                                        <input type="date" name="" class="form-control" id="">
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" v-model="serviceCharge">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-md-3 col-form-label">Analyst:</label>
                                   <div class="col-md-9">
    ...
    export default {
        ...
        methods: {
            ...
            postdata() {
                ...
                axios.post('/api/addIeJob', jobData, {
                        headers: headers
                    })
                    .then(res => {
