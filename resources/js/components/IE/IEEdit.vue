            ...
            >
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="letterReport">
                                Letter Duplicate Report
                            </h5>
                            <button
                                type="button"
                                class="close"
            ...
            <div class="tab-content" id="myTabContent">
                                ...
                                >
                                    ...
                                    <div id="section2">
                                        ...
                                        >
                                            ...
                                            <hr
                                                style="background-color: #275129"
                                            />
                                        </fieldset>
                                        <fieldset
                                            id="section1"
                                            v-show="selected == 'Bank'"
                                        >
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <div
                                                        class="form-check ml-4 islamic-check"
                                                    >
                                                        <input
                                                            type="checkbox"
                                                            class="form-check-input"
                                    ...
                                    <div class="">
                                        <div class="form-group row">
                                            <label
                                                for=""
                                                class="col-md-3 col-form-label"
                                                >Operational Branch:</label
                                            >
                                            <div class="col-md-9">
                                                <Select :options="regions" label="text" v-model="operationalBranch">
                                                </Select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            >
                                            <div class="col-md-5">
                                                 <input v-model="serviceCharge" class="form-control form-control-sm">
                                            </div>
                                            <div class="col-md-4">
                                                <input
                                                    type="checkbox"
                ...
                >
                    ...
                    >
                        <a href="#"
                            ><button class="btn btn-success">
                                <i class="fa fa-plus pr-2"></i>Hire Godown
                                Keeper
                            </button></a
                        >
                        <a href="#"
                            ><button class="btn btn-success">
                                <i class="fa fa-plus pr-2"></i>Re-Hire Godown
                                Keeper
                            </button></a
                        >
                        <a href="#"
                            ><button class="btn btn-success">
                                <i class="fa fa-plus pr-2"></i>Attach Hired
                                Godown Keeper
                            </button></a
                        >
                        <br />
...
export default {
    ...
    methods: {
        getInspectionJob() {
            axios.get("/getIeJob/" + this.id).then(res => {
                ...
                res.data.job.forEach(obj => {
                    ...
                    this.mucResPrint =
                        obj.is_print_representative === 1 ? true : false;
                    ...
                    this.insuranceNextLine =
                        obj.insurance_next_line === 1 ? true : false;
                    this.insuranceRemarks = obj.insurance_remarks;

                    this.inspectioneStockInspector =
                        obj.inspection_stock_inspector;
                    ...
                    this.inspectionStockReportDate =
                        obj.inspection_stock_report_date;
                    ...
                    this.isPrintFacility =
                        obj.is_facility_print === 1 ? true : false;
                    ...
                    this.isTravelCharges =
                        obj.is_travel_charges === 1 ? true : false;
        ...
        onComplete: function() {
            ...
            axios
                .put("/updateIEJob/" + this.id, {
                    ...
                    // declared_currency_print_attachments: this
                    //     .declaredCurrencyAttachments,
                    // declared_as_per: this.declaredAsPer,
                    // declared_no_label_input: this.declaredNoLabelInput,
                    // declared_no_label_attachments: this
                    //     .declaredNoLabelAttachments,
                    ...
                    // inspection_stock_report_date: this
                    //     .inspectionStockReportDate,
