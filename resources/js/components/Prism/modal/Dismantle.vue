<template>
    <div>
        <div class="form-group row pl-2 pr-2">
                ...
                <label class="col-sm-2 pt-3"></label>
...
<script>
  ...
  import 'vue-simple-suggest/dist/styles.css' 
    export default{
        ...
        axios.put('/updateDismantle/'+this.id,formData).then(res=>{
        ...
        this.$forceUpdate();
            ...
            this.recs=[];
                axios.get('/getAccessoriesToBeDismantle/'+this.id).then((res) => {
    ...
    axios.put('/updateDismantle',formData).then(res=>{
    ...
    addToBeReplaced()
    {
        axios.post('/addToBeDismantle/'+this.id).then(res=>{
            // alert('Updated Successfully');
                // this.getRecords();
                // alert(res.data);
                this.recs.push({
    ...
    //     });
        ...
        deleteAccessories(index,id){
            ...
            axios.post('/deleteAccessoryToBeDismantle/'+id).then(res=>{
