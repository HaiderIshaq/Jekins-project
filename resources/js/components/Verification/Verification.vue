    ...
    <div class="bg-white border-radius-4 box-shadow mb-30" style="padding:0px 15px 16px 15px">
      ...
      <div class="clearfix"  >
            <div class="row" style="background-color:#275129;padding-bottom:15px">
                <div class="col-md-10">
                    <h4 class="text-white  pt-3">New Verification Job</h4>
                </div>
                ...
                <div class="col-md-6 col-sm-12" style="padding: 0px 30px 0px 30px;">
                    ...
                    <div class="section-2">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-sm-9 pl-0">
                                    <input type="text" v-model="applicantName" class="form-control form-control-sm mt-2" id="applicantName" value="">
                                </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-9" style="padding-left:0px">
                                    <Select  label="text"   :class="['mySelect']" :options="qcofficers" v-model="qcofficer"></Select>
                        ...
                        <div class="form-group row" >
                            ...
                            <input type="button" data-toggle="modal" data-target="#excelModal" class="btn btn-primary" style="float:right;margin:10px" value="Upload Excel Sheet">
...
import Excel from './modal/Excel.vue';
  ...
  export default {
    ...
    postdata(){
       ...
       var eddate=this.edd.getFullYear()+"-"+month+"-"+this.edd.getDate();
        ...
        is_hold:this.isHoldByCustomer,
        hold_reason:this.HoldByCustomerValue,
        product_type:this.productType,
        product_sub_type:this.applicantIs.text,
        qc_officer:this.qcofficer.value,
        };
            console.log(jobData);
            const  headers= {
        ...
        axios.post('/api/addVerificationJob',jobData,{
            headers:headers
        })
            .then(res=>{
